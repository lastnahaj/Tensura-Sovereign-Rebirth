...
- Major progression ownership
- Baseline manifest identities
- Quest architecture target
- Storage architecture
- Permission/claim architecture
- Documentation structure
- Integrated Tensura reference architecture

## Verified through current build branch
...
- LuckPerms non-OP permission audit
- Tensura claim protection tests
- YIGD candidate
- Embeddium candidate
