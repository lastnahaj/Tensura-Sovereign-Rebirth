...
forbidden_patterns = {
    ...
    "private archive reference": re.compile(
        "PRIVATE_REFERENCE_"
        + r"DO_NOT_COMMIT|Tempest-Protocol-"
        + r"ftbquests\.rar|Tempest"
        + r"[- ]Protocol[- ]Quest[- ]Reference|privately "
        + r"supplied quest archive",
        re.IGNORECASE,
    ),
