...
[Tensura: Reincarnated Wiki](https://tensura.wiki.gg/), synchronized on `2026-08-27T16:57:13Z`.
...
[Creative Commons Attribution-ShareAlike 4.0 License](https://creativecommons.org/licenses/by-sa/4.0). Adapted upstream text in
