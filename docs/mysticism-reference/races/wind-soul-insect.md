...
4.50</div></div><div class="druid-row druid-row-KnockbackResist" data-druid-section-row="SpecificStats"><div class="druid-label druid-label-KnockbackResist">Knockback Resist</div><div class="druid-data druid-data-KnockbackResist druid-data-nonempty">
