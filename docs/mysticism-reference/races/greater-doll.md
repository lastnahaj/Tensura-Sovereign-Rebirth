---
title: Greater Doll
description: (Remove this once finalized) Loses Possession Skill Achieved by Possessing a Golem as a Greater Daemon. Archdoll - 140K EP as a Greater Doll. 1.21.1 – ??? 1.19.2 – Added to the game.
tags:
- Work_in_Progress
- Races
...
<img src="../../../assets/upstream/mysticism/races/mysticism-wip-6c2780ef0a.png" alt="Greater Doll source reference" loading="eager" decoding="async">
...
</p><div class="druid-infobox druid-container noexcerpt druid-container-race" id="druid-container-1"><div><div class="druid-title">Greater Doll</div></div><div class="druid-section-container"><div data-druid-section="GenericStats"><div class="druid-section druid-section-GenericStats">Generic Stats</div></div><div class="druid-row druid-row-HP" data-druid-section-row="GenericStats"><div class="druid-label druid-label-HP">HP</div><div class="druid-data druid-data-HP druid-data-nonempty">
...
30K - 60K</div></div><div class="druid-row druid-row-APRange" data-druid-section-row="GenericStats"><div class="druid-label druid-label-APRange">AP Range</div><div class="druid-data druid-data-APRange druid-data-nonempty">
...
TR Mysticism reference adapted from [Greater Doll](https://trmysticism.wiki.gg/wiki/Greater_Doll) on the Tensura Reincarnated: Mysticism Wiki (revision `3422`, modified `2026-07-14T05:30:15Z`). Adapted text is available under [CC BY-SA 4.0](https://creativecommons.org/licenses/by-sa/4.0/).
