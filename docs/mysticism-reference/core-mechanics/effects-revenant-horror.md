...
description: Revenant Horror is an effect that...
tags:
- Work_in_Progress
---
...
<img src="../../../assets/upstream/mysticism/misc/effectplaceholder-b97da4c888.png" alt="Revenant Horror source reference" loading="eager" decoding="async">
...
TR Mysticism reference adapted from [Effects/Revenant Horror](https://trmysticism.wiki.gg/wiki/Effects/Revenant_Horror) on the Tensura Reincarnated: Mysticism Wiki (revision `3311`, modified `2026-07-03T20:41:13Z`). Adapted text is available under [CC BY-SA 4.0](https://creativecommons.org/licenses/by-sa/4.0/).
