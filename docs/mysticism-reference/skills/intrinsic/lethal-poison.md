---
title: Lethal Poison
description: As the King of Scorpions, your poison is highly dangerous. An upgrade to the Poison skill.
tags:
...
<figure class="reference-overview-media reference-overview-media--source"><img src="../../../../assets/upstream/mysticism/skills/lethal-poison-00abc6cfac.png" alt="Lethal Poison source icon" loading="eager" decoding="async"><figcaption><a href="https://trmysticism.wiki.gg/wiki/File:Lethal_Poison.png">Lethal Poison.png · CC BY-SA 4.0</a></figcaption></figure>
...
King Scorpion Evolution Line</li></ul><p class="skill-evidence-note">An obtainment method is separate from a skill’s MP cost. Check all conditions; a listed route is not a guaranteed starting roll.</p></section>
<!-- skill-catalogue:end -->

<div class="tensura-reference-article">
<div class="mw-content-ltr mw-parser-output" dir="ltr" lang="en"><p>As the King of Scorpions, your poison is highly dangerous. An upgrade to the Poison skill.
</p>
<div class="druid-infobox druid-container noexcerpt druid-container-skill" id="druid-container-1"><div><div class="druid-title">Lethal Poison</div></div><div class="druid-section-container"><div class="druid-main-image"><a class="image" href="https://trmysticism.wiki.gg/wiki/File:Lethal_Poison.png"><img alt="Lethal Poison.png" data-file-height="512" data-file-width="512" decoding="async" height="256" loading="lazy" src="../../../../assets/upstream/mysticism/skills/lethal-poison-00abc6cfac.png" width="256"/></a></div></div><div class="druid-section-container"><div data-druid-section="Information"><div class="druid-section druid-section-Information">Information</div></div><div class="druid-row druid-row-Type" data-druid-section-row="Information"><div class="druid-label druid-label-Type">Type</div><div class="druid-data druid-data-Type druid-data-nonempty">Intrinsic Skill</div></div><div class="druid-row druid-row-ObtainCost" data-druid-section-row="Information"><div class="druid-label druid-label-ObtainCost">Obtain Cost</div><div class="druid-data druid-data-ObtainCost druid-data-nonempty">
...
Master <a class="external text" href="https://tensurareincarnated.wiki.gg/wiki/Abilities/Skills/Poison">Poison</a></div></div></div><div class="druid-section-container"><div data-druid-section="Obtaining"><div class="druid-section druid-section-Obtaining">Obtaining</div></div><div class="druid-row druid-row-Race" data-druid-section-row="Obtaining"><div class="druid-label druid-label-Race">Race</div><div class="druid-data druid-data-Race druid-data-nonempty">
King Scorpion Evolution Line</div></div></div></div>
<h2><span class="mw-headline" id="Usage">Usage</span></h2>
<h3><span class="mw-headline" id="Passive">Passive</span></h3>
<ul><li>[Passive, In Slot] Lethal Poison - Inflict powerful lethal poison into any enemy you touch, crippling your victim with Fatal Poison 3. On mastery, this becomes toggleable and becomes Fatal Poison 6.</li></ul>
...
TR Mysticism reference adapted from [Lethal Poison](https://trmysticism.wiki.gg/wiki/Lethal_Poison) on the Tensura Reincarnated: Mysticism Wiki (revision `3451`, modified `2026-08-16T22:09:40Z`). Adapted text is available under [CC BY-SA 4.0](https://creativecommons.org/licenses/by-sa/4.0/).

<details class="reference-media-credits">
<summary>Media credits (1 source files)</summary>
<ul>
<li><a href="https://trmysticism.wiki.gg/wiki/File:Lethal_Poison.png">Lethal Poison.png</a> — CC BY-SA 4.0; uploaded by Warrenboy1; revision 1250</li>
</ul>
</details>
