---
title: Spark
description: Light your fists and weaponry ablaze."
tags:
- Intrinsic_Skills
...
<figure class="reference-overview-media reference-overview-media--source"><img src="../../../../assets/upstream/mysticism/skills/spark-ae86cc4417.png" alt="Spark source icon" loading="eager" decoding="async"><figcaption><a href="https://trmysticism.wiki.gg/wiki/File:Spark.png">Spark.png · CC BY-SA 4.0</a></figcaption></figure>
...
Fire Ants</li></ul><p class="skill-evidence-note">An obtainment method is separate from a skill’s MP cost. Check all conditions; a listed route is not a guaranteed starting roll.</p></section>
<!-- skill-catalogue:end -->

<div class="tensura-reference-article">
<div class="mw-content-ltr mw-parser-output" dir="ltr" lang="en"><p>Light your fists and weaponry ablaze."
</p>
<div class="druid-infobox druid-container noexcerpt druid-container-skill" id="druid-container-1"><div><div class="druid-title">Spark</div></div><div class="druid-section-container"><div class="druid-main-image"><a class="image" href="https://trmysticism.wiki.gg/wiki/File:Spark.png"><img alt="Spark.png" data-file-height="512" data-file-width="512" decoding="async" height="256" loading="lazy" src="../../../../assets/upstream/mysticism/skills/spark-ae86cc4417.png" width="256"/></a></div></div><div class="druid-section-container"><div data-druid-section="Information"><div class="druid-section druid-section-Information">Information</div></div><div class="druid-row druid-row-Type" data-druid-section-row="Information"><div class="druid-label druid-label-Type">Type</div><div class="druid-data druid-data-Type druid-data-nonempty">Intrinsic Skill</div></div><div class="druid-row druid-row-ObtainCost" data-druid-section-row="Information"><div class="druid-label druid-label-ObtainCost">Obtain Cost</div><div class="druid-data druid-data-ObtainCost druid-data-nonempty">
...
Fire Ants</div></div></div></div>
<h2><span class="mw-headline" id="Usage">Usage</span></h2>
<h3><span class="mw-headline" id="Passive">Passive</span></h3>
<ul><li>[Passive, In Slot] Spark - Set your enemies when you attack them, akin to Fire Aspect. When mastered, upgrades to Fire Aspect II and becomes a Passive, Toggle.</li></ul>
...
<img alt="" decoding="async" loading="lazy" src="../../../../assets/upstream/mysticism/skills/missing-model-inventory-je2-7c0a10e5b2.png"/>
<span class="reference-related-copy">
...
TR Mysticism reference adapted from [Spark](https://trmysticism.wiki.gg/wiki/Spark) on the Tensura Reincarnated: Mysticism Wiki (revision `3183`, modified `2026-07-01T17:24:10Z`). Adapted text is available under [CC BY-SA 4.0](https://creativecommons.org/licenses/by-sa/4.0/).

<details class="reference-media-credits">
<summary>Media credits (1 source files)</summary>
<ul>
<li><a href="https://trmysticism.wiki.gg/wiki/File:Spark.png">Spark.png</a> — CC BY-SA 4.0; uploaded by Hunterman4488; revision 3184</li>
</ul>
</details>
