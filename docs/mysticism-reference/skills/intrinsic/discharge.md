---
title: Discharge
description: Strike a bolt of lightning using your inner bio-electricity generated from a sac within you. Can be used without thundering weather.
tags:
- Intrinsic_Skills
...
<figure class="reference-overview-media reference-overview-media--source"><img src="../../../../assets/upstream/mysticism/skills/discharge-34b8bc76fa.png" alt="Discharge source icon" loading="eager" decoding="async"><figcaption><a href="https://trmysticism.wiki.gg/wiki/File:Discharge.png">Discharge.png · CC BY-SA 4.0</a></figcaption></figure>
...
Overloading Worms</li></ul><p class="skill-evidence-note">An obtainment method is separate from a skill’s MP cost. Check all conditions; a listed route is not a guaranteed starting roll.</p></section>
<!-- skill-catalogue:end -->

<div class="tensura-reference-article">
<div class="mw-content-ltr mw-parser-output" dir="ltr" lang="en"><p>Strike a bolt of lightning using your inner bio-electricity generated from a sac within you. Can be used without thundering weather.
</p>
<div class="druid-infobox druid-container noexcerpt druid-container-skill" id="druid-container-1"><div><div class="druid-title">Discharge</div></div><div class="druid-section-container"><div class="druid-main-image"><a class="image" href="https://trmysticism.wiki.gg/wiki/File:Discharge.png"><img alt="Discharge.png" data-file-height="512" data-file-width="512" decoding="async" height="256" loading="lazy" src="../../../../assets/upstream/mysticism/skills/discharge-34b8bc76fa.png" width="256"/></a></div></div><div class="druid-section-container"><div data-druid-section="Information"><div class="druid-section druid-section-Information">Information</div></div><div class="druid-row druid-row-Type" data-druid-section-row="Information"><div class="druid-label druid-label-Type">Type</div><div class="druid-data druid-data-Type druid-data-nonempty">Intrinsic Skill</div></div><div class="druid-row druid-row-ObtainCost" data-druid-section-row="Information"><div class="druid-label druid-label-ObtainCost">Obtain Cost</div><div class="druid-data druid-data-ObtainCost druid-data-nonempty">
...
Overloading Worms</div></div></div></div>
<h2><span class="mw-headline" id="Usage">Usage</span></h2>
<h3><span class="mw-headline" id="Active">Active</span></h3>
<ul><li>[Active, Press] Discharge - Generic a powerful lightning bolt and call it down on the target. Can be used without thundering weather.
<ul><li>Cannot be used if you are not of the Charged Perforator race line.</li></ul></li></ul>
...
TR Mysticism reference adapted from [Discharge](https://trmysticism.wiki.gg/wiki/Discharge) on the Tensura Reincarnated: Mysticism Wiki (revision `2520`, modified `2026-02-19T01:06:04Z`). Adapted text is available under [CC BY-SA 4.0](https://creativecommons.org/licenses/by-sa/4.0/).

<details class="reference-media-credits">
<summary>Media credits (1 source files)</summary>
<ul>
<li><a href="https://trmysticism.wiki.gg/wiki/File:Discharge.png">Discharge.png</a> — CC BY-SA 4.0; uploaded by Warrenboy1; revision 1255</li>
</ul>
</details>
