...
description: Burst forth with great speed and power, enhancing your abilities for a short period of time.
tags:
- Intrinsic_Skills
...
<figure class="reference-overview-media reference-overview-media--source"><img src="../../../../assets/upstream/mysticism/skills/lightning-mode-70097842da.png" alt="Lightning Mode source icon" loading="eager" decoding="async"><figcaption><a href="https://trmysticism.wiki.gg/wiki/File:Lightning_Mode.png">Lightning Mode.png · CC BY-SA 4.0</a></figcaption></figure>
...
Lightning Soul Insects</li></ul><p class="skill-evidence-note">An obtainment method is separate from a skill’s MP cost. Check all conditions; a listed route is not a guaranteed starting roll.</p></section>
<!-- skill-catalogue:end -->

<div class="tensura-reference-article">
<div class="mw-content-ltr mw-parser-output" dir="ltr" lang="en"><p>Burst forth with great speed and power, enhancing your abilities for a short period of time.
</p>
<div class="druid-infobox druid-container noexcerpt druid-container-skill" id="druid-container-1"><div><div class="druid-title">Lightning Mode</div></div><div class="druid-section-container"><div class="druid-main-image"><a class="image" href="https://trmysticism.wiki.gg/wiki/File:Lightning_Mode.png"><img alt="Lightning Mode.png" data-file-height="512" data-file-width="512" decoding="async" height="256" loading="lazy" src="../../../../assets/upstream/mysticism/skills/lightning-mode-70097842da.png" width="256"/></a></div></div><div class="druid-section-container"><div data-druid-section="Information"><div class="druid-section druid-section-Information">Information</div></div><div class="druid-row druid-row-Type" data-druid-section-row="Information"><div class="druid-label druid-label-Type">Type</div><div class="druid-data druid-data-Type druid-data-nonempty">Intrinsic Skill</div></div><div class="druid-row druid-row-ObtainCost" data-druid-section-row="Information"><div class="druid-label druid-label-ObtainCost">Obtain Cost</div><div class="druid-data druid-data-ObtainCost druid-data-nonempty">
...
Lightning Soul Insects</div></div></div></div>
<h2><span class="mw-headline" id="Usage">Usage</span></h2>
<h3><span class="mw-headline" id="Active">Active</span></h3>
<ul><li>[Active, Press] It allows the user to gain 0.1F more movement speed and 12.0F attack damage for a short period of time. 600 second cooldown. 300 when mastered.</li></ul>
...
TR Mysticism reference adapted from [Lightning Mode](https://trmysticism.wiki.gg/wiki/Lightning_Mode) on the Tensura Reincarnated: Mysticism Wiki (revision `2526`, modified `2026-02-19T01:07:16Z`). Adapted text is available under [CC BY-SA 4.0](https://creativecommons.org/licenses/by-sa/4.0/).

<details class="reference-media-credits">
<summary>Media credits (1 source files)</summary>
<ul>
<li><a href="https://trmysticism.wiki.gg/wiki/File:Lightning_Mode.png">Lightning Mode.png</a> — CC BY-SA 4.0; uploaded by Warrenboy1; revision 1249</li>
</ul>
</details>
