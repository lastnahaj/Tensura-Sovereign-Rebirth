...
<img src="../../../../assets/upstream/mysticism/skills/hell-gate-e7224d82ec.png" alt="Hell Gate source reference" loading="eager" decoding="async">
<figcaption><a href="https://trmysticism.wiki.gg/wiki/File:Hell_Gate.png">Hell Gate.png · CC BY-SA 4.0</a></figcaption>
</figure>
...
<div class="mw-content-ltr mw-parser-output" dir="ltr" lang="en"><p>Your demonic prowess allows you to enter Hell at will, creating a portal between both dimensions and instantly warping to the other side.
</p>
<div class="druid-infobox druid-container noexcerpt druid-container-skill" id="druid-container-1"><div><div class="druid-title">Hell Gate</div></div><div class="druid-section-container"><div class="druid-main-image"><a class="image" href="https://trmysticism.wiki.gg/wiki/File:Hell_Gate.png"><img alt="Hell Gate.png" data-file-height="512" data-file-width="512" decoding="async" height="256" loading="lazy" src="../../../../assets/upstream/mysticism/skills/hell-gate-e7224d82ec.png" width="256"/></a></div></div><div class="druid-section-container"><div data-druid-section="Information"><div class="druid-section druid-section-Information">Information</div></div><div class="druid-row druid-row-Type" data-druid-section-row="Information"><div class="druid-label druid-label-Type">Type</div><div class="druid-data druid-data-Type druid-data-nonempty">
...
<ul><li>[Active, Press] Warp (Hell) - Teleports the user to Hell. Doesn't work if you're in Hell.</li></ul>
<p>Skill has cooldown of 600 seconds, 300 upon mastery.
</p>
...
TR Mysticism reference adapted from [Hell Gate](https://trmysticism.wiki.gg/wiki/Hell_Gate) on the Tensura Reincarnated: Mysticism Wiki (revision `3448`, modified `2026-08-16T22:06:26Z`). Adapted text is available under [CC BY-SA 4.0](https://creativecommons.org/licenses/by-sa/4.0/).

<details class="reference-media-credits">
<summary>Media credits (1 source files)</summary>
<ul>
<li><a href="https://trmysticism.wiki.gg/wiki/File:Hell_Gate.png">Hell Gate.png</a> — CC BY-SA 4.0; uploaded by Warrenboy1; revision 1252</li>
</ul>
</details>
