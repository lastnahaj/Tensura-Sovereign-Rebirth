---
title: Poison Transform
description: Channel your inner poison to inject deadly venom into your target trough every pore.
tags:
- Intrinsic_Skills
...
<img src="../../../../assets/upstream/mysticism/skills/poison-transform-ac54b3eeb0.png" alt="Poison Transform source reference" loading="eager" decoding="async">
<figcaption><a href="https://trmysticism.wiki.gg/wiki/File:Poison_Transform.png">Poison Transform.png · CC BY-SA 4.0</a></figcaption>
</figure>
...
<div class="mw-content-ltr mw-parser-output" dir="ltr" lang="en"><p>Channel your inner poison to inject deadly venom into your target trough every pore.
</p>
<div class="druid-infobox druid-container noexcerpt druid-container-skill" id="druid-container-1"><div><div class="druid-title">Poison Transform</div></div><div class="druid-section-container"><div class="druid-main-image"><a class="image" href="https://trmysticism.wiki.gg/wiki/File:Poison_Transform.png"><img alt="Poison Transform.png" data-file-height="512" data-file-width="512" decoding="async" height="256" loading="lazy" src="../../../../assets/upstream/mysticism/skills/poison-transform-ac54b3eeb0.png" width="256"/></a></div></div><div class="druid-section-container"><div data-druid-section="Information"><div class="druid-section druid-section-Information">Information</div></div><div class="druid-row druid-row-Type" data-druid-section-row="Information"><div class="druid-label druid-label-Type">Type</div><div class="druid-data druid-data-Type druid-data-nonempty">
...
<a href="../../../races/poison-soul-insect/" title="Poison Soul Insect">Poison Soul Insect</a></div></div></div></div>
<h2><span class="mw-headline" id="Usage">Usage</span></h2>
<h3><span class="mw-headline" id="Active">Active</span></h3>
<ul><li>[Active, Hold] Poison Transform: At the cost of 50% speed, deal 2 poison damage and apply "Deadly Poison" for all mobs within a 10x10 radius</li></ul>
...
TR Mysticism reference adapted from [Poison Transform](https://trmysticism.wiki.gg/wiki/Poison_Transform) on the Tensura Reincarnated: Mysticism Wiki (revision `3463`, modified `2026-08-25T19:41:54Z`). Adapted text is available under [CC BY-SA 4.0](https://creativecommons.org/licenses/by-sa/4.0/).

<details class="reference-media-credits">
<summary>Media credits (1 source files)</summary>
<ul>
<li><a href="https://trmysticism.wiki.gg/wiki/File:Poison_Transform.png">Poison Transform.png</a> — CC BY-SA 4.0; uploaded by Warrenboy1; revision 1246</li>
</ul>
</details>
