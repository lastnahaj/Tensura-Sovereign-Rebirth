---
title: Gardener
description: The crops, the wild, everything was there for you. You sow the seeds and wish only for a bountiful harvest. And in turn, the crops bless you.
tags:
- Unique_Skills
...
<div class="mw-content-ltr mw-parser-output" dir="ltr" lang="en"><p>The crops, the wild, everything was there for you. You sow the seeds and wish only for a bountiful harvest. And in turn, the crops bless you.
</p>
<div class="druid-infobox druid-container noexcerpt druid-container-skill" id="druid-container-1"><div><div class="druid-title">Gardener</div></div><div class="druid-section-container"><div class="druid-main-image"><a class="image" href="https://trmysticism.wiki.gg/wiki/File:Gardener.png"><img alt="Gardener.png" data-file-height="512" data-file-width="512" decoding="async" height="256" loading="lazy" src="../../../../assets/upstream/mysticism/skills/gardener-51f67bd405.png" width="256"/></a></div></div><div class="druid-section-container"><div data-druid-section="Information"><div class="druid-section druid-section-Information">Information</div></div><div class="druid-row druid-row-Type" data-druid-section-row="Information"><div class="druid-label druid-label-Type">Type</div><div class="druid-data druid-data-Type druid-data-nonempty">Unique Skill</div></div><div class="druid-row druid-row-ObtainCost" data-druid-section-row="Information"><div class="druid-label druid-label-ObtainCost">Obtain Cost</div><div class="druid-data druid-data-ObtainCost druid-data-nonempty">
...
Demeter, Lord of Agriculture</div></div></div><div class="druid-section-container"><div data-druid-section="Obtaining"><div class="druid-section druid-section-Obtaining">Obtaining</div></div><div class="druid-row druid-row-Other" data-druid-section-row="Obtaining"><div class="druid-label druid-label-Other">Other</div><div class="druid-data druid-data-Other druid-data-nonempty">
Reincarnation/Reroll</div></div></div></div>

<h2><span class="mw-headline" id="Usage">Usage</span></h2>
<h3><span class="mw-headline" id="Passive">Passive</span></h3>
<ul><li>[Passive, True] Hoe Mastery - All hoes deal increased damage, allowing even a wooden hoe to be useful.</li></ul>
<ul><li>[Passive, Toggled] Crop Mastery - Nearby crops have a 50% chance (per crop) every 5 seconds to grow by one stage. allowing you to vastly speed up the process of growing any crops. Consumes 20 MP every 5 seconds when toggled on.</li></ul>
<p><br/>
</p>
<h3><span class="mw-headline" id="Active">Active</span></h3>
<ul><li>[Active, Press] Blessing - Bless the food stack you're holding. Based on the current time of day, blessing the food will grant various helpful buffs. You can give these foods to any entity as well, allowing you to give buffs to them.</li></ul>
<p>For each item in the stack, consume 250 MP. On mastery, the cost increases to 500 MP per food item.
</p><p>Blessed at Dawn: Gain Strengthen 3 for 3 minutes (Strengthen 5 for 5 minutes on mastery) from consuming it.
Blessed at Noon: Gain Resistance 1 for 3 minutes (Resistance 2 for 3 minutes on mastery) from consuming it.
Blessed at Night: Gain Speed 3 and 2.0 Step Height for 3 minutes (Speed 5 and 3.0 Step Height for 5 minutes on mastery) from consuming it.
</p><p>This mode gains mastery differently! It DIVIDES the points you would gain by 10, based on how many items were in the item stack, rounded down to the nearest whole number.
For example, if I had a stack of 64 Steak, I would gain 6 mastery points instead of 1. However, if I were to just bless one, two, three, four, five, eight, or nine items, it would be 0 mastery points. You MUST minimally bless a stack of 10 to gain mastery.
</p>
...
TR Mysticism reference adapted from [Gardener](https://trmysticism.wiki.gg/wiki/Gardener) on the Tensura Reincarnated: Mysticism Wiki (revision `2549`, modified `2026-02-19T01:13:03Z`). Adapted text is available under [CC BY-SA 4.0](https://creativecommons.org/licenses/by-sa/4.0/).

<details class="reference-media-credits">
<summary>Media credits (1 source files)</summary>
<ul>
<li><a href="https://trmysticism.wiki.gg/wiki/File:Gardener.png">Gardener.png</a> — CC BY-SA 4.0; uploaded by Warrenboy1; revision 2002</li>
</ul>
</details>
