...
<img src="../../../../assets/upstream/mysticism/skills/inverse-8f8d5c05b3.png" alt="Inverse source reference" loading="eager" decoding="async">
<figcaption><a href="https://trmysticism.wiki.gg/wiki/File:Inverse.png">Inverse.png · CC BY-SA 4.0</a></figcaption>
</figure>
...
<div class="druid-infobox druid-container noexcerpt druid-container-skill" id="druid-container-1"><div><div class="druid-title">Inverse</div></div><div class="druid-section-container"><div class="druid-main-image"><a class="image" href="https://trmysticism.wiki.gg/wiki/File:Inverse.png"><img alt="Inverse.png" data-file-height="512" data-file-width="512" decoding="async" height="256" loading="lazy" src="../../../../assets/upstream/mysticism/skills/inverse-8f8d5c05b3.png" width="256"/></a></div></div><div class="druid-section-container"><div data-druid-section="Information"><div class="druid-section druid-section-Information">Information</div></div><div class="druid-row druid-row-Type" data-druid-section-row="Information"><div class="druid-label druid-label-Type">Type</div><div class="druid-data druid-data-Type druid-data-nonempty">
...
<a href="../../ultimate/antithesis/" title="Antithesis"> Antithesis, Lord Of Inversion</a></div></div></div></div>

<h2><span class="mw-headline" id="Usage">Usage</span></h2>
<h3><span class="mw-headline" id="Passive">Passive</span></h3>
<ul><li>[Passive, Toggle] Damage Redirection - Any magic damage taken by the user is countered fully. (double the damage on mastery)</li></ul>
<ul><li>[Passive, True, requires Mastery] Destiny Switch - When User takes damage below 25% swaps their place with the farthest mob in a 40 block radius.</li></ul>
<p><br/>
</p>
<h3><span class="mw-headline" id="Active">Active</span></h3>
<ul><li>[Active, Press] Malice Exchange: Takes your or an entities debuffs and lets you put it onto other entities.</li></ul>
<ul><li>[Active, Press] Redirect - Lets you swap the places of yourself with a different entity.</li></ul>
...
TR Mysticism reference adapted from [Inverse](https://trmysticism.wiki.gg/wiki/Inverse) on the Tensura Reincarnated: Mysticism Wiki (revision `2552`, modified `2026-02-19T01:13:30Z`). Adapted text is available under [CC BY-SA 4.0](https://creativecommons.org/licenses/by-sa/4.0/).

<details class="reference-media-credits">
<summary>Media credits (1 source files)</summary>
<ul>
<li><a href="https://trmysticism.wiki.gg/wiki/File:Inverse.png">Inverse.png</a> — CC BY-SA 4.0; uploaded by Warrenboy1; revision 1263</li>
</ul>
</details>
