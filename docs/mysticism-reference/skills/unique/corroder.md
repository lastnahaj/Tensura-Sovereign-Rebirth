---
title: Corroder
description: Corroder? More toxic than my ex somehow
tags:
- Unique_Skills
...
<div class="mw-content-ltr mw-parser-output" dir="ltr" lang="en"><p>Corroder? More toxic than my ex somehow
</p>
<div class="druid-infobox druid-container noexcerpt druid-container-skill" id="druid-container-1"><div><div class="druid-title">Corroder</div></div><div class="druid-section-container"><div class="druid-main-image"><a class="image" href="https://trmysticism.wiki.gg/wiki/File:Corroder.png"><img alt="Corroder.png" data-file-height="128" data-file-width="128" decoding="async" height="256" loading="lazy" src="../../../../assets/upstream/mysticism/skills/corroder-1ce411eb5a.png" width="256"/></a></div></div><div class="druid-section-container"><div data-druid-section="Information"><div class="druid-section druid-section-Information">Information</div></div><div class="druid-row druid-row-Type" data-druid-section-row="Information"><div class="druid-label druid-label-Type">Type</div><div class="druid-data druid-data-Type druid-data-nonempty">Unique Skill</div></div><div class="druid-row druid-row-ObtainCost" data-druid-section-row="Information"><div class="druid-label druid-label-ObtainCost">Obtain Cost</div><div class="druid-data druid-data-ObtainCost druid-data-nonempty">
25K</div></div><div class="druid-row druid-row-PointstoMaster" data-druid-section-row="Information"><div class="druid-label druid-label-PointstoMaster">Points to Master</div><div class="druid-data druid-data-PointstoMaster druid-data-nonempty">
...
<ul><li>Passive, Toggle] Corrosive Touch - All your physical attacks now apply the corrosion effect. When unmastered, this effect is applied at Corrosion 2 for 10 seconds. On mastery, this upgrades to Corrosion 3 for 15 seconds. This is changeable in the config.</li></ul>
<ul><li>[Passive, In Slot] Corrosion Ward - Corrosion will NEVER apply to you.</li></ul>
<p><br/>
</p>
<h3><span class="mw-headline" id="Active">Active</span></h3>
<ul><li>[Active, Held] Dissolve - Emit a dissolving aura around you, melting any targets nearby. This drains 100 MP/s, changeable in the config, and deals 10 Corrosive damage. It also additionally applies Corrosion 1 to all targets for 10 seconds.
<ul><li>On mastery, this upgrades to 15 Corrosion Damage, applying Corrosion 2 to all targets for 15 seconds,</li></ul></li></ul>
<ul><li>[Art (requires learning), Press] Cross Corrosion - Instantly coat your blade in corrosive acid. On your next attack, slash for heavy, armor-ignoring damage. This attack uses 1000.0 Magicules and is configurable in the config.</li></ul>
<p><br/>
</p>
...
TR Mysticism reference adapted from [Corroder](https://trmysticism.wiki.gg/wiki/Corroder) on the Tensura Reincarnated: Mysticism Wiki (revision `3087`, modified `2026-06-24T16:49:09Z`). Adapted text is available under [CC BY-SA 4.0](https://creativecommons.org/licenses/by-sa/4.0/).

<details class="reference-media-credits">
<summary>Media credits (1 source files)</summary>
<ul>
<li><a href="https://trmysticism.wiki.gg/wiki/File:Corroder.png">Corroder.png</a> — CC BY-SA 4.0; uploaded by Just grinding; revision 3079</li>
</ul>
</details>
