...
description: Boosts the power of Ice abilities by a decent amount.
tags:
- Extra_Skills
...
<a href="../ice-domination/" title="Ice Domination">Ice Domination</a> + 400k EP</div></div></div><div class="druid-section-container"><div data-druid-section="Obtaining"><div class="druid-section druid-section-Obtaining">Obtaining</div></div><div class="druid-row druid-row-Other" data-druid-section-row="Obtaining"><div class="druid-label druid-label-Other">Other</div><div class="druid-data druid-data-Other druid-data-nonempty">
Mastering 1 Ice Spell/Skill</div></div></div></div>
<h2><span class="mw-headline" id="Usage">Usage</span></h2>
<h3><span class="mw-headline" id="Passive">Passive</span></h3>
<ul><li>[Passive, Toggle] Boost - All ice abilities/spells do 2x more damage</li></ul>
...
TR Mysticism reference adapted from [Ice Manipulation](https://trmysticism.wiki.gg/wiki/Ice_Manipulation) on the Tensura Reincarnated: Mysticism Wiki (revision `2535`, modified `2026-02-19T01:09:14Z`). Adapted text is available under [CC BY-SA 4.0](https://creativecommons.org/licenses/by-sa/4.0/).

<details class="reference-media-credits">
<summary>Media credits (1 source files)</summary>
<ul>
<li><a href="https://trmysticism.wiki.gg/wiki/File:Ice_Manipulation.png">Ice Manipulation.png</a> — CC BY-SA 4.0; uploaded by Warrenboy1; revision 1301</li>
</ul>
</details>
