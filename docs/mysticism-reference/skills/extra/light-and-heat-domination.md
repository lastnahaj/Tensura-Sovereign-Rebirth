...
<figcaption><a href="https://trmysticism.wiki.gg/wiki/File:Light_and_Head_Domination.png">Light and Head Domination.png · CC BY-SA 4.0</a></figcaption>
</figure>
...
Upon learning <a href="../../ultimate/amaterasu/" title="Amaterasu">Amaterasu</a></div></div></div></div>

<h2><span class="mw-headline" id="Usage">Usage</span></h2>
<h3><span class="mw-headline" id="Passive">Passive</span></h3>
<ul><li>[Passive, Toggle] Boost - increases damage dealt by fire and light attack x8 (does not stack with flame manipulation/domination and light manipulation/domination).</li></ul>
<p><br/>
</p>
<h3><span class="mw-headline" id="Active">Active</span></h3>
<ul><li>[Active - Hold] Black Flame Breath: Breathe black flames that do 10 damage per second (20 when mastered). Cost 50 MP per second.</li></ul>
...
TR Mysticism reference adapted from [Light and Heat Domination](https://trmysticism.wiki.gg/wiki/Light_and_Heat_Domination) on the Tensura Reincarnated: Mysticism Wiki (revision `2538`, modified `2026-02-19T01:10:23Z`). Adapted text is available under [CC BY-SA 4.0](https://creativecommons.org/licenses/by-sa/4.0/).
