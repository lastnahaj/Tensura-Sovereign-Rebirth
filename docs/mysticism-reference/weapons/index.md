...
<a class="reference-directory-overview-link" href="items-weapons/">Read collection overview <span aria-hidden="true">→</span></a>
</div>
</div>
</header>
...
<p class="reference-filter-status" aria-live="polite">Showing 0 of 0 articles</p>
</div>
