...
| Former mimicry integration | TensuraMorph / ReMorphed / Woodwalkers | Creature forms | Retired integration | Historical versions only | Removed | Former startup results do not indicate current inclusion; CraftedCore remains independently listed |
