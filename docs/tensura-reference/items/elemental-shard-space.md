...
Base Tensura reference adapted from [Elemental Shard (Space)](https://tensura.wiki.gg/wiki/Elemental_Shard_(Space)) on the Tensura: Reincarnated Wiki (revision `9543`, modified `2025-04-23T18:56:57Z`). Adapted text is available under [CC BY-SA 4.0](https://creativecommons.org/licenses/by-sa/4.0/).
