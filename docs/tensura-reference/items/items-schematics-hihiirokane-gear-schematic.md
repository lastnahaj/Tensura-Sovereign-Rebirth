---
title: HihiIrokane Gear Schematic
description: Obtained by picking up an HihiIrokane Ingot Allows Crafting of Hihi'Irokane tools/armor
tags:
- Missing_renewability
- Items/Schematics/Hihi'Irokane Gear Schematic
---

# HihiIrokane Gear Schematic

<span class="reference-badge">Base Tensura reference</span> <span class="reference-category">Items & Materials</span>

**Also known as:** Items/Schematics/Hihi'Irokane Gear Schematic

<div class="tensura-reference-article">
<div class="mw-content-ltr mw-parser-output" dir="ltr" lang="en"><aside class="portable-infobox noexcerpt searchaux pi-background pi-theme-default pi-layout-default"><h2 class="pi-item pi-item-spacing pi-title" data-source="title">HihiIrokane Gear Schematic</h2><figure class="pi-item pi-media pi-image" data-source="image">
...
<p>Obtained by picking up an  <span class="nowrap"><span class="sprite-file"><a href="../hihiirokane-ingot/" title="HihiIrokane Ingot"></a></span> <a href="../hihiirokane-ingot/" title="HihiIrokane Ingot"><span class="sprite-text">HihiIrokane Ingot</span></a></span>
</p>
<h2><span class="mw-headline" id="Usage">Usage</span></h2>
<p><br/>
Allows Crafting of Hihi'Irokane tools/armor
</p>
...
Base Tensura reference adapted from [Items/Schematics/HihiIrokane Gear Schematic](https://tensura.wiki.gg/wiki/Items/Schematics/HihiIrokane_Gear_Schematic) on the Tensura: Reincarnated Wiki (revision `10506`, modified `2025-08-26T11:36:31Z`). Adapted text is available under [CC BY-SA 4.0](https://creativecommons.org/licenses/by-sa/4.0/).
