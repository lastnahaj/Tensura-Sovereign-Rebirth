...
<img src="../../../assets/upstream/tensura/items/invicon-ice-blade-88d548eb7c.png" alt="Ice Blade source reference" loading="eager" decoding="async">
<figcaption><a href="https://tensura.wiki.gg/wiki/File:Invicon_Ice_Blade.png">Invicon Ice Blade.png · CC BY-SA 4.0</a></figcaption>
</figure>
...
<ul><li>+0.25 Sweep</li></ul>
<h2><span class="mw-headline" id="Obtainment">Obtainment</span></h2>
<h3><span class="mw-headline" id="Crafting">Crafting</span></h3>
<p>To craft, you need a <a href="../../blocks/blocks-smithing-bench/" title="Blocks/Smithing Bench">Smithing Bench</a> and have used <a href="../items-schematics-high-magisteel-gear-schematic/" title="Items/Schematics/High Magisteel Gear Schematic">High Magisteel Gear Schematic </a>, and <a href="../items-schematics-long-sword-schematic/" title="Items/Schematics/Long Sword Schematic"> Long Sword Schematic</a>
</p>
...
<td>
<pre> <span class="nowrap"><a class="new" href="https://tensura.wiki.gg/wiki/High_Magisteel_Ingot,_3?action=edit&amp;redlink=1" rel="nofollow" title="High Magisteel Ingot, 3 (page does not exist)">High Magisteel Ingot, 3</a> +<br/><a class="new" href="https://tensura.wiki.gg/wiki/Elemental_Core_(Water),_2?action=edit&amp;redlink=1" rel="nofollow" title="Elemental Core (Water), 2 (page does not exist)">Elemental Core (Water), 2</a> +<br/><a class="new" href="https://tensura.wiki.gg/wiki/Eye_of_Ender?action=edit&amp;redlink=1" rel="nofollow" title="Eye of Ender (page does not exist)">Eye of Ender</a> +<br/><a class="extiw" href="https://minecraft.wiki/w/Stick" title="mcw:Stick">Stick</a></span>
</pre>
</td>
<td>
<div><span class="mcui mcui-Smithing_Table pixel-image"><span class="mcui-smithingTable"><span class="invslot mcui-input1"><span class="invslot-item invslot-item-image" data-minetip-title="High Magisteel Ingot"><a href="../high-magisteel-ingot/" title="High Magisteel Ingot"></a><span class="invslot-stacksize" title="High Magisteel Ingot">3</span></span></span><span class="invslot mcui-input2"><span class="invslot-item invslot-item-image" data-minetip-title="Elemental Core (Water)"><a class="new" href="https://tensura.wiki.gg/wiki/Special:Upload?wpDestFile=Invicon_Elemental_Core_(Water).gif" title="File:Invicon Elemental Core (Water).gif">Elemental Core (Water)</a><span class="invslot-stacksize" title="Elemental Core (Water)">2</span></span></span><span class="invslot mcui-input3"><span class="invslot-item invslot-item-image" data-minetip-title="Eye of Ender"><a class="new" href="https://tensura.wiki.gg/wiki/Special:Upload?wpDestFile=Invicon_Eye_of_Ender.gif" title="File:Invicon Eye of Ender.gif">Eye of Ender</a></span></span><span class="invslot mcui-input4"><span class="invslot-item invslot-item-image" data-minetip-title="Stick"><a href="https://minecraft.wiki/w/Stick" title="Stick"></a></span></span><span class="invslot mcui-input5"></span></span><span class="mcui-arrow"></span><span class="mcui-output"><span class="invslot invslot"><span class="invslot-item invslot-item-image" data-minetip-title="Ice Blade"><a href="./" title="Ice Blade"></a></span></span></span></span></div>
</td>
</tr>
</tbody></table>
<p><br/>
...
<span class="reference-related-copy">
<strong>Insectar Carapace</strong>
...
<span class="reference-related-copy">
<strong>Invisible Feather</strong>
...
Base Tensura reference adapted from [Ice Blade](https://tensura.wiki.gg/wiki/Ice_Blade) on the Tensura: Reincarnated Wiki (revision `12620`, modified `2026-04-27T12:55:14Z`). Adapted text is available under [CC BY-SA 4.0](https://creativecommons.org/licenses/by-sa/4.0/).
