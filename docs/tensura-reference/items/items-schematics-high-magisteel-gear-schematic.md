...
description: Obtained by picking up a High Magisteel Ingot Allows Crafting of High Magisteel tools/armor
tags:
...
<p>Obtained by picking up a  <span class="nowrap"><span class="sprite-file"><a href="../high-magisteel-ingot/" title="High Magisteel Ingot"></a></span> <a href="../high-magisteel-ingot/" title="High Magisteel Ingot"><span class="sprite-text">High Magisteel Ingot</span></a></span>
</p>
<h2><span class="mw-headline" id="Usage">Usage</span></h2>
<p><br/>
Allows Crafting of High Magisteel tools/armor
</p>
...
Base Tensura reference adapted from [Items/Schematics/High Magisteel Gear Schematic](https://tensura.wiki.gg/wiki/Items/Schematics/High_Magisteel_Gear_Schematic) on the Tensura: Reincarnated Wiki (revision `9439`, modified `2025-04-23T17:47:48Z`). Adapted text is available under [CC BY-SA 4.0](https://creativecommons.org/licenses/by-sa/4.0/).
