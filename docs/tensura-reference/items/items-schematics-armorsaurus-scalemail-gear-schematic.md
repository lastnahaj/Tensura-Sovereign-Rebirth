---
title: Armorsaurus Scalemail Schematic
description: Obtained by picking up an Armorsaurus Scale Allows Crafting of Armorsaurus Scalemail (tools?)/armor
tags:
- Missing_renewability
---

# Armorsaurus Scalemail Schematic

<span class="reference-badge">Base Tensura reference</span> <span class="reference-category">Items & Materials</span>

<div class="tensura-reference-article">
<div class="mw-content-ltr mw-parser-output" dir="ltr" lang="en"><aside class="portable-infobox noexcerpt searchaux pi-background pi-theme-default pi-layout-default"><h2 class="pi-item pi-item-spacing pi-title" data-source="title">Armorsaurus Scalemail Gear Schematic</h2><figure class="pi-item pi-media pi-image" data-source="image">
...
<p>Obtained by picking up an <span class="nowrap"><span class="sprite-file"><a href="../armorsaurus-scale/" title="Armorsaurus Scale"></a></span> <a href="../armorsaurus-scale/" title="Armorsaurus Scale"><span class="sprite-text">Armorsaurus Scale</span></a></span>
</p>
<h2><span class="mw-headline" id="Usage">Usage</span></h2>
<p><br/>
Allows Crafting of Armorsaurus Scalemail (tools?)/armor
</p>
...
Base Tensura reference adapted from [Items/Schematics/Armorsaurus Scalemail Gear Schematic](https://tensura.wiki.gg/wiki/Items/Schematics/Armorsaurus_Scalemail_Gear_Schematic) on the Tensura: Reincarnated Wiki (revision `12347`, modified `2026-04-21T09:17:33Z`). Adapted text is available under [CC BY-SA 4.0](https://creativecommons.org/licenses/by-sa/4.0/).
