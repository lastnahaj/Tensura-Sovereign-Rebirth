---
title: Serpent Scalemail Gear Schematic
description: Obtained by picking up a Serpent Scale Allows Crafting of Serpent Scalemail (tools?)/armor
tags:
- Missing_renewability
---

# Serpent Scalemail Gear Schematic

<span class="reference-badge">Base Tensura reference</span> <span class="reference-category">Items & Materials</span>

<div class="tensura-reference-article">
<div class="mw-content-ltr mw-parser-output" dir="ltr" lang="en"><aside class="portable-infobox noexcerpt searchaux pi-background pi-theme-default pi-layout-default"><h2 class="pi-item pi-item-spacing pi-title" data-source="title">Serpent Scalemail Gear Schematic</h2><figure class="pi-item pi-media pi-image" data-source="image">
...
<p>Obtained by picking up a <span class="nowrap"><span class="sprite-file"><a href="../serpent-scale/" title="Items/Mob Drops/Serpent Scale"></a></span> <a class="mw-redirect" href="../serpent-scale/" title="Items/Mob Drops/Serpent Scale"><span class="sprite-text"> Serpent Scale</span></a></span>
</p>
<h2><span class="mw-headline" id="Usage">Usage</span></h2>
<p><br/>
Allows Crafting of Serpent Scalemail (tools?)/armor
</p>
...
Base Tensura reference adapted from [Items/Schematics/Serpent Scalemail Gear Schematic](https://tensura.wiki.gg/wiki/Items/Schematics/Serpent_Scalemail_Gear_Schematic) on the Tensura: Reincarnated Wiki (revision `4088`, modified `2024-12-27T17:41:24Z`). Adapted text is available under [CC BY-SA 4.0](https://creativecommons.org/licenses/by-sa/4.0/).
