...
Base Tensura reference adapted from [Cattledeer Steak](https://tensura.wiki.gg/wiki/Cattledeer_Steak) on the Tensura: Reincarnated Wiki (revision `13054`, modified `2026-06-13T09:08:47Z`). Adapted text is available under [CC BY-SA 4.0](https://creativecommons.org/licenses/by-sa/4.0/).
