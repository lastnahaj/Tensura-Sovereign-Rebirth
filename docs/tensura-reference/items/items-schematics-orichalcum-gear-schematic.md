---
title: Orichalcum Gear Schematic
description: Obtained by picking up an Orichalcum Ingot Allows Crafting of Orichalcum tools/armor
tags:
- Missing_renewability
---

# Orichalcum Gear Schematic

<span class="reference-badge">Base Tensura reference</span> <span class="reference-category">Items & Materials</span>

<div class="tensura-reference-article">
<div class="mw-content-ltr mw-parser-output" dir="ltr" lang="en"><aside class="portable-infobox noexcerpt searchaux pi-background pi-theme-default pi-layout-default"><h2 class="pi-item pi-item-spacing pi-title" data-source="title">Orichalcum Gear Schematic</h2><figure class="pi-item pi-media pi-image" data-source="image">
...
<p>Obtained by picking up an  <span class="nowrap"><span class="sprite-file"><a href="../orichalcum-ingot/" title="Orichalcum Ingot"></a></span> <a href="../orichalcum-ingot/" title="Orichalcum Ingot"><span class="sprite-text">Orichalcum Ingot</span></a></span>
</p>
<h2><span class="mw-headline" id="Usage">Usage</span></h2>
<p><br/>
Allows Crafting of Orichalcum tools/armor
</p>
...
Base Tensura reference adapted from [Items/Schematics/Orichalcum Gear Schematic](https://tensura.wiki.gg/wiki/Items/Schematics/Orichalcum_Gear_Schematic) on the Tensura: Reincarnated Wiki (revision `9443`, modified `2025-04-23T17:49:36Z`). Adapted text is available under [CC BY-SA 4.0](https://creativecommons.org/licenses/by-sa/4.0/).
