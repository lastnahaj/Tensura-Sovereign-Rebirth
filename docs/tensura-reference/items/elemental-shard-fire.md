...
<div class="infobox-imagearea animated-container"><div><a class="image" href="https://tensura.wiki.gg/wiki/File:Elemental_Shard_(Fire).png"><img alt="Elemental Shard (Fire).png: Infobox image for Elemental Shard (Fire) the item in Minecraft" class="pixel-image" data-file-height="512" data-file-width="512" decoding="async" height="160" src="../../../assets/upstream/tensura/items/elemental-shard-fire-59ba882e4b.png" width="160"/></a></div>
