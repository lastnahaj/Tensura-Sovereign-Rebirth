...
<div class="infobox-imagearea animated-container"><div><a class="image" href="https://tensura.wiki.gg/wiki/File:Invicon_Daemon_Core.png"><img alt="Invicon Daemon Core.png: Infobox image for Daemon Core the item in Minecraft" class="pixel-image" data-file-height="16" data-file-width="16" decoding="async" height="160" src="../../../assets/upstream/tensura/items/invicon-daemon-core-e014c44bd0.png" width="160"/></a></div>
...
Base Tensura reference adapted from [Daemon Core](https://tensura.wiki.gg/wiki/Daemon_Core) on the Tensura: Reincarnated Wiki (revision `13101`, modified `2026-06-15T11:19:00Z`). Adapted text is available under [CC BY-SA 4.0](https://creativecommons.org/licenses/by-sa/4.0/).
