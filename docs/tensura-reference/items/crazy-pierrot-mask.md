...
**Also known as:** Items/Armours/Crazy Pierrot Mask

<section class="reference-overview reference-theme-world">
<figure class="reference-overview-media reference-overview-media--source">
<img src="../../../assets/upstream/tensura/items/invicon-crazy-pierrot-mask-9201be74aa.png" alt="Crazy Pierrot Mask source reference" loading="eager" decoding="async">
<figcaption><a href="https://tensura.wiki.gg/wiki/File:Invicon_Crazy_Pierrot_Mask.png">Invicon Crazy Pierrot Mask.png · CC BY-SA 4.0</a></figcaption>
</figure>
...
<td>
<pre> <span class="nowrap"><a class="external text" href="https://minecraft.wiki/w/Clay_Ball" rel="nofollow">Clay Ball</a> + <a class="external text" href="https://minecraft.wiki/w/Yellow_Dye" rel="nofollow">Yellow Dye</a> + <a class="external text" href="https://minecraft.wiki/w/Black_Dye" rel="nofollow">Black Dye</a></span>
</pre>
</td>
<td>
<div><span class="mcui mcui-Smithing_Table pixel-image"><span class="mcui-smithingTable"><span class="invslot mcui-input1"><span class="invslot-item invslot-item-image" data-minetip-title="Clay Ball"><a href="https://tensura.wiki.gg/wiki/Clay_Ball" title="Clay Ball"></a><span class="invslot-stacksize" title="Clay Ball">2</span></span></span><span class="invslot mcui-input2"><span class="invslot-item invslot-item-image" data-minetip-title="Yellow Dye"><a href="https://tensura.wiki.gg/wiki/Yellow_Dye" title="Yellow Dye"></a></span></span><span class="invslot mcui-input3"><span class="invslot-item invslot-item-image" data-minetip-title="Black Dye"><a href="https://tensura.wiki.gg/wiki/Black_Dye" title="Black Dye"></a></span></span><span class="invslot mcui-input4"></span><span class="invslot mcui-input5"></span></span><span class="mcui-arrow"></span><span class="mcui-output"><span class="invslot invslot"><span class="invslot-item invslot-item-image" data-minetip-title="&amp;6Crazy Pierrot Mask"><a href="./" title="&amp;6Crazy Pierrot Mask"></a></span></span></span></span></div>
</td>
</tr>
</tbody></table>
<p><br/>
...
Base Tensura reference adapted from [Crazy Pierrot Mask](https://tensura.wiki.gg/wiki/Crazy_Pierrot_Mask) on the Tensura: Reincarnated Wiki (revision `9448`, modified `2025-04-23T17:52:55Z`). Adapted text is available under [CC BY-SA 4.0](https://creativecommons.org/licenses/by-sa/4.0/).
