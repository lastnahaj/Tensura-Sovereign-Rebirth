---
title: Grimoire(C)
description: A low level grimoire for casting magic. Grimoire (C) can hold 4 magics and cast these magics using its own EP. Chant speed increase = 5 Cooldown = 30 ticks Can be found in all type of wizard towers Uncraftable
tags:
- Work_in_Progress
...
<img src="../../../assets/upstream/tensura/items/invicon-grimoire-c-69d4b4d853.png" alt="Grimoire(C) source reference" loading="eager" decoding="async">
<figcaption><a href="https://tensura.wiki.gg/wiki/File:Invicon_Grimoire(C).png">Invicon Grimoire(C).png · CC BY-SA 4.0</a></figcaption>
</figure>
...
<div class="mcwiki-header infobox-title">Grimoire(C)</div>
<div class="infobox-imagearea animated-container">
<div class="infobox-invimages"><div><span class="invslot"><span class="invslot-item invslot-item-image" data-minetip-title="Grimoire(C)"><a href="./" title="Grimoire(C)"></a></span></span></div></div></div>
...
<p>A low level grimoire for casting magic.
</p>
<h2><span class="mw-headline" id="Usage">Usage</span></h2>
<p>Grimoire (C) can hold 4 magics and cast these magics using its own EP.<br/>
<a href="../../core-mechanics/chantspeed/" title="Chantspeed"> Chant speed</a> increase = 5<br/>
Cooldown = 30 ticks<br/>
</p>
...
Base Tensura reference adapted from [Grimoire(C)](https://tensura.wiki.gg/wiki/Grimoire(C)) on the Tensura: Reincarnated Wiki (revision `12843`, modified `2026-05-07T11:14:41Z`). Adapted text is available under [CC BY-SA 4.0](https://creativecommons.org/licenses/by-sa/4.0/).
