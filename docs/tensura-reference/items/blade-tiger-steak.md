...
<td><span> <b>Work In Progress.</b></span><br/> <i>This page is currently being worked on or has unfinished information.<br/>  Click <a class="external text" href="https://tensurareincarnated.wiki.gg/wiki/Blade_Tiger_Steak?action=edit">here</a> in order to contribute to this article.</i>
...
<a class="reference-related-card" href="../beast-horn/">
<img src="../../../assets/upstream/tensura/items/invicon-beast-horn-d658a03dd4.png" alt="" loading="lazy" decoding="async">
<span class="reference-related-copy">
<strong>Beast Horn</strong>
<small>A severed spike from the head or a horned creature.</small>
</span>
</a>
...
Base Tensura reference adapted from [Blade Tiger Steak](https://tensura.wiki.gg/wiki/Blade_Tiger_Steak) on the Tensura: Reincarnated Wiki (revision `9153`, modified `2025-04-14T10:20:07Z`). Adapted text is available under [CC BY-SA 4.0](https://creativecommons.org/licenses/by-sa/4.0/).
...
<li><a href="https://tensura.wiki.gg/wiki/File:Blade_Tiger_Steak.png">Blade Tiger Steak.png</a> — CC BY-SA 4.0; uploaded by Zykestheone; revision 6967</li>
