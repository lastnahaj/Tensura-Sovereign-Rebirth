...
description: Cut back on the cookies.
tags:
- Intrinsic_Skills
---
...
<img src="../../../../assets/upstream/tensura/skills/giantification-1ef521d21a.png" alt="Giantification source reference" loading="eager" decoding="async">
<figcaption><a href="https://tensura.wiki.gg/wiki/File:Giantification.png">Giantification.png · CC BY-SA 4.0</a></figcaption>
</figure>
...
<ul><li>[Active] Giantification: When activated, increases player height by 3 blocks and grants +6 Attack Damage (Speed, Jump Strength and Attack/Mining reach increases according to size change).
<ul><li>When mastered, gain the ability to choose size modification among [-1, 0, 1, 2, 3 blocks] increase while still keep the strength effect. Sneak-activate to turn off.</li></ul></li></ul>
<p><br/>
</p>
...
Base Tensura reference adapted from [Giantification](https://tensura.wiki.gg/wiki/Giantification) on the Tensura: Reincarnated Wiki (revision `11647`, modified `2026-04-03T12:40:27Z`). Adapted text is available under [CC BY-SA 4.0](https://creativecommons.org/licenses/by-sa/4.0/).

<details class="reference-media-credits">
<summary>Media credits (1 source files)</summary>
<ul>
<li><a href="https://tensura.wiki.gg/wiki/File:Giantification.png">Giantification.png</a> — CC BY-SA 4.0; uploaded by Rip Gold; revision 11652</li>
</ul>
</details>
