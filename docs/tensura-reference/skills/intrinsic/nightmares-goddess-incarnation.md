---
title: Goddess Incarnation
description: Possesion - Works like Possesion , however it only needs 1 requirement instead of 2
tags:
...
<a href="https://tensuranightmares.wiki.gg/wiki/Races/Lower_Class_Goddess" title="Races/Lower Class Goddess">Lower Class Goddess</a> and Evolutions</div></div></div></div>
<h2><span class="mw-headline" id="Usage">Usage</span></h2>
<h3><span class="mw-headline" id="Active">Active</span></h3>
<ul><li>[Active, Press] Possesion - Works like <a class="external text" href="https://tensura.wiki.gg/wiki/Possession%7C">Possesion</a>, however it only needs 1 requirement instead of 2</li></ul>
</div>
</div>
