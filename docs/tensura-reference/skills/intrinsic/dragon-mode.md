---
title: Dragon Mode
description: Once a day, draw out your monstrous potential to double your EP and to boost your physical prowess. Doing this will leave a temporary toll on your body.
tags:
- Intrinsic_Skills
- Abilities/Skills/Dragon Mode
---
...
**Also known as:** Abilities/Skills/Dragon Mode

<section class="reference-overview reference-theme-abilities">
<figure class="reference-overview-media reference-overview-media--source">
<img src="../../../../assets/upstream/tensura/skills/dragon-mode-7e0b783311.png" alt="Dragon Mode source reference" loading="eager" decoding="async">
<figcaption><a href="https://tensura.wiki.gg/wiki/File:Dragon_mode.png">Dragon mode.png · CC BY-SA 4.0</a></figcaption>
</figure>
...
<ul><li>[Active - Press] - On activation, grants the user a temporary 2x increase to their max Magicules and Aura; 20 Armor Points; a Strength 4 Effect and +0.05 Speed. It lasts for 3 Minutes and upon ending inflicts the player with Paralysis 2, Fragility 2, and Weakness 2 for 10 Minutes. It can only be used once a day. Mastery increases the duration to 6 Minutes.
<ul><li>Can't be activated along with the following skills
<ul><li><a href="../beast-transformation/" title="Beast Transformation">Beast Transformation</a></li>
...
Base Tensura reference adapted from [Dragon Mode](https://tensura.wiki.gg/wiki/Dragon_Mode) on the Tensura: Reincarnated Wiki (revision `11315`, modified `2026-03-31T20:03:46Z`). Adapted text is available under [CC BY-SA 4.0](https://creativecommons.org/licenses/by-sa/4.0/).

<details class="reference-media-credits">
<summary>Media credits (1 source files)</summary>
<ul>
<li><a href="https://tensura.wiki.gg/wiki/File:Dragon_mode.png">Dragon mode.png</a> — CC BY-SA 4.0; uploaded by Zykestheone; revision 3283</li>
</ul>
</details>
