...
<a href="../../unique/nightmares-endorse/" title="Endorse"> Endorse</a></div></div><div class="druid-row druid-row-Next" data-druid-section-row="Evolution"><div class="druid-label druid-label-Next">Next</div><div class="druid-data druid-data-Next druid-data-nonempty">
<a href="../nightmares-cthugha/" title="Cthugha">｢ Cthugha, King of Divine Flame ｣</a>, <a href="../nightmares-agni/" title="Agni">｢ Agni, Lord of Blaze ｣</a></div></div></div><div class="druid-section-container"><div data-druid-section="Obtaining"><div class="druid-section druid-section-Obtaining">Obtaining</div></div><div class="druid-row druid-row-Other" data-druid-section-row="Obtaining"><div class="druid-label druid-label-Other">Other</div><div class="druid-data druid-data-Other druid-data-nonempty">
Master Endorse, have enough MP, win 25 raids and heal a zombie villager</div></div></div></div>
<h2><span class="mw-headline" id="Usage">Usage</span></h2>
<h3><span class="mw-headline" id="Passive">Passive</span></h3>
<ul><li>[Passive, Toggle] Amplification and Thought Acceleration - The user regenerates Magicules x2 as fast (4x as fast on mastery). The user gains +2 Learning and Mastery Points. Increase magic casting speed multiplier by 3, increase movement speed by 0.02 (0.04 with Mastery), increase attack speed by 0.3 (0.6 with Mastery)</li></ul>
<h3><span class="mw-headline" id="Actives">Actives</span></h3>
<ul><li>[Active, Press] Encore - This is the same as Endorse' Encore, but it increases barriers by 45% (90% when mastered).</li>
...
<li>[Active, Press] Parallel Existence -This is the same as Alternative's Parallel Existence.</li>
<li>[Active, Press] Cardinal Acceleration (Only a mode if you have Acceleration) - Accelerates the user
<ul><li>When used shifting, the user fires a powerful beam that deals 250 Flame Damage (350 when mastered) and melts blocks when it hits them.</li>
<li>When used normally, the user accelerates forward at high speeds dealing a massive amount of damage in a straight line. 350 (500 Flame Damage when mastered) + Attack Damage.</li></ul></li></ul>
</div>
</div>
