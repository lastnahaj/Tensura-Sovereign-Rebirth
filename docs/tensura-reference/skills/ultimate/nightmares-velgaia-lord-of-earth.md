---
title: Velgaia, Lord of Earth-Star
description: Unobtainable due to no model for boss
tags:
- Dragon Ultimates
---

# Velgaia, Lord of Earth-Star
...
<figure class="reference-overview-media reference-overview-media--theme"><img src="../../../../assets/icons/skills/trnightmare-velgaia_lord_of_earth.svg" alt="Velgaia, Lord of Earth-Star emblem" width="96" height="96"><figcaption>TSR skill emblem</figcaption></figure>
...
Obtain 500 Bond Points</div></div></div></div>
<h2><span class="mw-headline" id="Usage">Usage</span></h2>
<h3><span class="mw-headline" id="Passive">Passive</span></h3>
<ul><li>[Passivey In-Slot] Earth-Type Magic - The user gains the Earth Magics. Also boosts their Earth and Gravity Damage by 50%.</li></ul>
<h3><span class="mw-headline" id="Actives">Actives</span></h3>
<ul><li>[Active, Hold] Earth Dragon Summon - The user holds down this skill for 1 minute (Goes down by 10 Seconds every 100 Mastery). After the duration is met, the user summons Velgaia in her human body. (When shift used, and the boss is added, summon Dragon Body Velgaia)</li>
<li>The Body grants:
<ul><li>1400 HP</li>
<li>8560 SHP</li>
<li>21 Attack damage</li>
<li>75 Armour</li></ul></li></ul>
</div>
</div>
...
Tensura Nightmares reference adapted from [Velgaia](https://tensuranightmares.wiki.gg/wiki/Velgaia) on the Tensura Reincarnated Nightmares Wiki (revision `2681`, modified `2026-08-07T15:38:42Z`). Adapted text is available under [CC BY-SA 4.0](https://creativecommons.org/licenses/by-sa/4.0/).
