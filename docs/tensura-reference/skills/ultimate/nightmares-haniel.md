---
title: Haniel, Lord of Glory
description: '"Thou attempts are pityfull, as my Glory shalt outshine thy being forevermore"'
tags:
- Ultimates
---
...
<figure class="reference-overview-media reference-overview-media--theme"><img src="../../../../assets/icons/skills/trnightmare-haniel.svg" alt="Haniel, Lord of Glory emblem" width="96" height="96"><figcaption>TSR skill emblem</figcaption></figure>
...
<a href="../../unique/nightmares-glorious/" title="Glorious"> Glorious</a></div></div><div class="druid-row druid-row-Next" data-druid-section-row="Evolution"><div class="druid-label druid-label-Next">Next</div><div class="druid-data druid-data-Next druid-data-nonempty">
<a href="../nightmares-hamiel/" title="Hamiel">「Hamiel, King of Splendour」</a></div></div></div><div class="druid-section-container"><div data-druid-section="Obtaining"><div class="druid-section druid-section-Obtaining">Obtaining</div></div><div class="druid-row druid-row-Other" data-druid-section-row="Obtaining"><div class="druid-label druid-label-Other">Other</div><div class="druid-data druid-data-Other druid-data-nonempty">
Master Glorious, have enough MP, win 6 raids and have 100 armour points</div></div></div></div>
<h2><span class="mw-headline" id="Usage">Usage</span></h2>
<h3><span class="mw-headline" id="Passive">Passive</span></h3>
<ul><li>[Passive, True] Evershining Glory - User does not lose health to spatial attacks and User masters skills faster.</li>
<li>[Passive, Toggle] Danger Sense</li>
<li>[Passive, Toggle] Hostility Identification - Sense all nearby entities and traps.</li>
<li>[Passive, Toggle] Automatic Recovery - Infinite regeneration at 1/2 cost</li>
<li>[Passive, Toggle] Accord of Energy - Nullifications and resistances are degraded 1 level. Dodge chances are ignored 70% and crit chances are 80%, guaranteed on mastery. 60% dodge chance and 60% projectile dodge chance, with 100% projectile chance on mastery</li>
<li>[Passive, In Slot] Offense-Defense Swap - When In slot, half of the damage the user takes is stored and added to the next attack. this amount is changed each time the user takes damage</li></ul>
</div>
</div>
...
Tensura Nightmares reference adapted from [Haniel](https://tensuranightmares.wiki.gg/wiki/Haniel) on the Tensura Reincarnated Nightmares Wiki (revision `2521`, modified `2026-07-26T17:37:39Z`). Adapted text is available under [CC BY-SA 4.0](https://creativecommons.org/licenses/by-sa/4.0/).
