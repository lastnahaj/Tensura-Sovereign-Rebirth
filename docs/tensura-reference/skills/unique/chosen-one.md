---
title: Chosen One
description: Radiate authority and charisma to force fear into the hearts of your enemies and to make them follow you instead, while empowering yourself and your allies.
tags:
- Unique_Skills
- Plundering_Skills
- Abilities/Skills/Chosen One
---
...
**Also known as:** Abilities/Skills/Chosen One

<section class="reference-overview reference-theme-abilities">
<figure class="reference-overview-media reference-overview-media--source">
<img src="../../../../assets/upstream/tensura/skills/chosen-one-b886bc9fd0.png" alt="Chosen One source reference" loading="eager" decoding="async">
<figcaption><a href="https://tensura.wiki.gg/wiki/File:Chosen_one.png">Chosen one.png · CC BY-SA 4.0</a></figcaption>
</figure>
...
<div class="mw-content-ltr mw-parser-output" dir="ltr" lang="en"><p>Radiate authority and charisma to force fear into the hearts of your enemies and to make them follow you instead, while empowering yourself and your allies.
</p>
<div class="druid-infobox druid-container druid-container-skill" id="druid-container-1"><div><div class="druid-title">Chosen One</div></div><div class="druid-section-container"><div class="druid-main-image"><a class="image" href="https://tensura.wiki.gg/wiki/File:Chosen_one.png"><img alt="Chosen one.png" data-file-height="512" data-file-width="512" decoding="async" height="256" loading="lazy" src="../../../../assets/upstream/tensura/skills/chosen-one-b886bc9fd0.png" width="256"/></a></div></div><div class="druid-section-container"><div data-druid-section="Information"><div class="druid-section druid-section-Information">Information</div></div><div class="druid-row druid-row-Type" data-druid-section-row="Information"><div class="druid-label druid-label-Type">Type</div><div class="druid-data druid-data-Type druid-data-nonempty">
...
<ul><li>[Active - Hold] <b>Hero’s Haki</b>: 25 MP per 20 ticks. When activated, all mobs within a 30x30 radius are affected, If their EP is =&lt;75% of the user's used EP, it does nothing. Otherwise, give 1 Fear level for each 20% difference with the used EP</li></ul>
<ul><li>[Active - Press] <b>Hero’s Charisma</b> : When activated, all passive and neutral mobs within a 20x20 radius will be treated as the player's allies and will assist them in combat for 120s [Negated by Spiritual Attack Nullification, reduced to 60s by Resistance]. Any mobs they or the player defeat will be resurrected as allies with half max health (Except Undead). When mastered this will only occur while Hero's Charisma is in-slot. Costs 200 MP.</li></ul>
...
<ul>
<li><a href="https://tensura.wiki.gg/wiki/File:Chosen_one.png">Chosen one.png</a> — CC BY-SA 4.0; uploaded by Zykestheone; revision 3431</li>
</ul>
</details>
