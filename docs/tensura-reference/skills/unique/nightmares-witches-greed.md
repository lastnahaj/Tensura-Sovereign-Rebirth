...
<ul><li>[Passive, In-Slot] Lion's Heart - The user is immune to any damage dealt to their HP stat., unless the attack possess Time Manipualation from skills or x2 the user's EP.. This requires a Vessel to be sat.</li>
<li>[Passive, Toggle] Little King - All attacks performed by the user deal 10 spatial-type damage.</li></ul>
<h3><span class="mw-headline" id="Active">Active</span></h3>
<ul><li>[Active, Press] Lion Vessel - Allows the user to place their heart into a vessel, permitting Lion’s Heart to be used. A vessel is only usable for two minutes.</li>
<li>[Active, Press] Zero Velocity - Allows the user to launch an attack using a time-stopped blade which deals 25 damage.</li></ul>
</div>
</div>
