---
title: Absolute Severance
description: Wield the power to cut through any who stand in your path, whether by coating your strikes or launching slashing projectiles that sever all in their path.
tags:
- Unique_Skills
- Abilities/Skills/Absolute Severance
---
...
**Also known as:** Abilities/Skills/Absolute Severance

<section class="reference-overview reference-theme-abilities">
<figure class="reference-overview-media reference-overview-media--source">
<img src="../../../../assets/upstream/tensura/skills/absolute-severance-8e134814ba.png" alt="Absolute Severance source reference" loading="eager" decoding="async">
<figcaption><a href="https://tensura.wiki.gg/wiki/File:Absolute_severance.png">Absolute severance.png · CC BY-SA 4.0</a></figcaption>
</figure>
...
<div class="mw-content-ltr mw-parser-output" dir="ltr" lang="en"><p>Wield the power to cut through any who stand in your path, whether by coating your strikes or launching slashing projectiles that sever all in their path.
</p>
<div class="druid-infobox druid-container druid-container-skill" id="druid-container-1"><div><div class="druid-title">Absolute Severance</div></div><div class="druid-section-container"><div class="druid-main-image"><a class="image" href="https://tensura.wiki.gg/wiki/File:Absolute_severance.png"><img alt="Absolute severance.png" data-file-height="512" data-file-width="512" decoding="async" height="256" loading="lazy" src="../../../../assets/upstream/tensura/skills/absolute-severance-8e134814ba.png" width="256"/></a></div></div><div class="druid-section-container"><div data-druid-section="Information"><div class="druid-section druid-section-Information">Information</div></div><div class="druid-row druid-row-Type" data-druid-section-row="Information"><div class="druid-label druid-label-Type">Type</div><div class="druid-data druid-data-Type druid-data-nonempty">Unique Skill</div></div><div class="druid-row druid-row-ObtainCost" data-druid-section-row="Information"><div class="druid-label druid-label-ObtainCost">Obtain Cost</div><div class="druid-data druid-data-ObtainCost druid-data-nonempty">
...
<ul><li>[Active - Press] - <b>Coating</b>: Costs 1,000 MP, adds a 50 (200 if mastered) damage boost, as well as a severance effect to the player's attacks for 60 seconds.
<ul><li><b>Resist Bypass</b>: Bypasses Resistances and treats Nullifications as Resistances while coat is active.</li></ul></li>
<li>[Active - Press] - <b>Projectile</b>: Costs 20,000 MP, launches an invisible projectile that deals 50 (300 with Mastery) Damage and has a severance effect. Projectile is 5 blocks(10 with mastery). 3s Cooldown</li></ul>
<p><br/>
</p>
...
Base Tensura reference adapted from [Absolute Severance](https://tensura.wiki.gg/wiki/Absolute_Severance) on the Tensura: Reincarnated Wiki (revision `12685`, modified `2026-05-04T22:25:12Z`). Adapted text is available under [CC BY-SA 4.0](https://creativecommons.org/licenses/by-sa/4.0/).

<details class="reference-media-credits">
<summary>Media credits (1 source files)</summary>
<ul>
<li><a href="https://tensura.wiki.gg/wiki/File:Absolute_severance.png">Absolute severance.png</a> — CC BY-SA 4.0; uploaded by Zykestheone; revision 3425</li>
</ul>
</details>
