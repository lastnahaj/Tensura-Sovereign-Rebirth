---
title: Chef
description: Purify and renew. Remove all negative effects and restore vitality to those under your care.
tags:
- Unique_Skills
- Abilities/Skills/Chef
---
...
**Also known as:** Abilities/Skills/Chef

<section class="reference-overview reference-theme-abilities">
<figure class="reference-overview-media reference-overview-media--source">
<img src="../../../../assets/upstream/tensura/skills/chef-cc146bcafe.png" alt="Chef source reference" loading="eager" decoding="async">
<figcaption><a href="https://tensura.wiki.gg/wiki/File:Chef.png">Chef.png · CC BY-SA 4.0</a></figcaption>
</figure>
...
<div class="mw-content-ltr mw-parser-output" dir="ltr" lang="en"><p>Purify and renew. Remove all negative effects and restore vitality to those under your care.
</p>
<div class="druid-infobox druid-container druid-container-skill" id="druid-container-1"><div><div class="druid-title">Chef</div></div><div class="druid-section-container"><div class="druid-main-image"><a class="image" href="https://tensura.wiki.gg/wiki/File:Chef.png"><img alt="Chef.png" data-file-height="512" data-file-width="512" decoding="async" height="256" loading="lazy" src="../../../../assets/upstream/tensura/skills/chef-cc146bcafe.png" width="256"/></a></div></div><div class="druid-section-container"><div data-druid-section="Information"><div class="druid-section druid-section-Information">Information</div></div><div class="druid-row druid-row-Type" data-druid-section-row="Information"><div class="druid-label druid-label-Type">Type</div><div class="druid-data druid-data-Type druid-data-nonempty">Unique Skill</div></div><div class="druid-row druid-row-ObtainCost" data-druid-section-row="Information"><div class="druid-label druid-label-ObtainCost">Obtain Cost</div><div class="druid-data druid-data-ObtainCost druid-data-nonempty">
...
<ul><li>[Active - Press] When used while not looking at a target, remove all negative status effects from the user and restore their hp to full including Severance damage. When looking at a mob, remove all their negative status effects and restores their hp to full. Costs 60 MP (40 with Mastery) each healed HP and 100 MP each effect level removed.</li></ul>
...
Base Tensura reference adapted from [Chef](https://tensura.wiki.gg/wiki/Chef) on the Tensura: Reincarnated Wiki (revision `8203`, modified `2025-03-12T16:16:46Z`). Adapted text is available under [CC BY-SA 4.0](https://creativecommons.org/licenses/by-sa/4.0/).

<details class="reference-media-credits">
<summary>Media credits (1 source files)</summary>
<ul>
<li><a href="https://tensura.wiki.gg/wiki/File:Chef.png">Chef.png</a> — CC BY-SA 4.0; uploaded by Zykestheone; revision 3430</li>
</ul>
</details>
