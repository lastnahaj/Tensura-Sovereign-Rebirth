---
title: Guardian
description: Stand as a bastion against the force of your enemies. Absorb the damage from your allies and fortify their defenses.
tags:
- Unique_Skills
- Abilities/Skills/Guardian
---
...
**Also known as:** Abilities/Skills/Guardian

<section class="reference-overview reference-theme-abilities">
<figure class="reference-overview-media reference-overview-media--source">
<img src="../../../../assets/upstream/tensura/skills/guardian-bc0571df8a.png" alt="Guardian source reference" loading="eager" decoding="async">
<figcaption><a href="https://tensura.wiki.gg/wiki/File:Guardian.png">Guardian.png · CC BY-SA 4.0</a></figcaption>
</figure>
...
<div class="mw-content-ltr mw-parser-output" dir="ltr" lang="en"><p>Stand as a bastion against the force of your enemies. Absorb the damage from your allies and fortify their defenses.
</p>
<div class="druid-infobox druid-container druid-container-skill" id="druid-container-1"><div><div class="druid-title">Guardian</div></div><div class="druid-section-container"><div class="druid-main-image"><a class="image" href="https://tensura.wiki.gg/wiki/File:Guardian.png"><img alt="Guardian.png" data-file-height="512" data-file-width="512" decoding="async" height="256" loading="lazy" src="../../../../assets/upstream/tensura/skills/guardian-bc0571df8a.png" width="256"/></a></div></div><div class="druid-section-container"><div data-druid-section="Information"><div class="druid-section druid-section-Information">Information</div></div><div class="druid-row druid-row-Type" data-druid-section-row="Information"><div class="druid-label druid-label-Type">Type</div><div class="druid-data druid-data-Type druid-data-nonempty">Unique Skill</div></div><div class="druid-row druid-row-ObtainCost" data-druid-section-row="Information"><div class="druid-label druid-label-ObtainCost">Obtain Cost</div><div class="druid-data druid-data-ObtainCost druid-data-nonempty">
...
<ul><li>[Passive - Toggle] <b>Substitution</b> : The player takes damage in place of their subordinates [Not working for Spiritual Damage or damage dealt by the owner]</li></ul>
<h3><span class="mw-headline" id="Active">Active</span></h3>
<ul><li>[Active - Press] <b>Grant Protection</b> : Grants all nearby subordinates/allies 10 extra armor points and 30 barrier points for 180 seconds. Costs 100 MP</li></ul>
<ul><li>[Active - Toggle] <b>Iron Wall</b> : Grants the player an additional 15 (40 with Mastery) Armour Points and 0.4 (1 with Mastery) Knockback Resistance.</li></ul>
...
Base Tensura reference adapted from [Guardian](https://tensura.wiki.gg/wiki/Guardian) on the Tensura: Reincarnated Wiki (revision `12697`, modified `2026-05-04T22:28:44Z`). Adapted text is available under [CC BY-SA 4.0](https://creativecommons.org/licenses/by-sa/4.0/).

<details class="reference-media-credits">
<summary>Media credits (1 source files)</summary>
<ul>
<li><a href="https://tensura.wiki.gg/wiki/File:Guardian.png">Guardian.png</a> — CC BY-SA 4.0; uploaded by Zykestheone; revision 3391</li>
</ul>
</details>
