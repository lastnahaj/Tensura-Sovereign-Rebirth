---
title: Severer
description: Slice through reality and manifest spatial blades which cut through armor and unleash devastating blade storms.
tags:
- Unique_Skills
- Abilities/Skills/Severer
---
...
**Also known as:** Abilities/Skills/Severer

<section class="reference-overview reference-theme-abilities">
<figure class="reference-overview-media reference-overview-media--source">
<img src="../../../../assets/upstream/tensura/skills/severer-526ab7baaf.png" alt="Severer source reference" loading="eager" decoding="async">
<figcaption><a href="https://tensura.wiki.gg/wiki/File:Severer.png">Severer.png · CC BY-SA 4.0</a></figcaption>
</figure>
...
<ul><li>[Active - Press] - <b>Dummy Sword</b>: At the cost of 100 MP, creates a Spatial Blade (with Severance V - X with mastery) in an empty hand slot. Blades infinitely regenerate at the cost of 20 MP per blade.</li></ul>
<ul><li>[Active - Press] - <b>Blade Storm</b>: Require Spatial Blade to be in 1 of the user’s hand. At the cost of 2000 MP, unleashes 5 (10 with mastery) Severance Blades from behind the user to looked-at target (max range 20 blocks - 30 with Mastery). Cooldown 5s (3s with mastery).</li></ul>
<ul><li>[Active - Press] - <b>Severance</b>: Applies a severance effect and a 10 (30 with Mastery) damage boost to the player's attacks for 120 seconds. Costs 200 MP.</li></ul>
...
Base Tensura reference adapted from [Severer](https://tensura.wiki.gg/wiki/Severer) on the Tensura: Reincarnated Wiki (revision `12708`, modified `2026-05-04T22:31:15Z`). Adapted text is available under [CC BY-SA 4.0](https://creativecommons.org/licenses/by-sa/4.0/).

<details class="reference-media-credits">
<summary>Media credits (1 source files)</summary>
<ul>
<li><a href="https://tensura.wiki.gg/wiki/File:Severer.png">Severer.png</a> — CC BY-SA 4.0; uploaded by Zykestheone; revision 3410</li>
</ul>
</details>
