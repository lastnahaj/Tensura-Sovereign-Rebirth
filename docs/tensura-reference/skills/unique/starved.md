...
<img src="../../../../assets/upstream/tensura/skills/starved-158392b37f.png" alt="Starved source reference" loading="eager" decoding="async">
<figcaption><a href="https://tensura.wiki.gg/wiki/File:Starved.png">Starved.png · CC BY-SA 4.0</a></figcaption>
</figure>
...
Use <a class="mw-redirect" href="../predator/" title="Abilities/Skills/Predator"> Predator</a> to predate a mob/player with <a class="mw-selflink selflink">Starved</a></li><li><strong>Race:</strong>
<a href="../../../races/races-orc-lord/" title="Races/Orc Lord">Orc Lord</a></li></ul><p class="skill-evidence-note">An obtainment method is separate from a skill’s MP cost. Check all conditions; a listed route is not a guaranteed starting roll.</p></section>
<!-- skill-catalogue:end -->
...
<div class="druid-infobox druid-container druid-container-skill" id="druid-container-1"><div><div class="druid-title">Starved</div></div><div class="druid-section-container"><div class="druid-main-image"><a class="image" href="https://tensura.wiki.gg/wiki/File:Starved.png"><img alt="Starved.png" data-file-height="512" data-file-width="512" decoding="async" height="256" loading="lazy" src="../../../../assets/upstream/tensura/skills/starved-158392b37f.png" width="256"/></a></div></div><div class="druid-section-container"><div data-druid-section="Information"><div class="druid-section druid-section-Information">Information</div></div><div class="druid-row druid-row-Type" data-druid-section-row="Information"><div class="druid-label druid-label-Type">Type</div><div class="druid-data druid-data-Type druid-data-nonempty">Unique Skill</div></div><div class="druid-row druid-row-ObtainCost" data-druid-section-row="Information"><div class="druid-label druid-label-ObtainCost">Obtain Cost</div><div class="druid-data druid-data-ObtainCost druid-data-nonempty">
...
<ul>
<li><a href="https://tensura.wiki.gg/wiki/File:Starved.png">Starved.png</a> — CC BY-SA 4.0; uploaded by Zykestheone; revision 3415</li>
</ul>
</details>
