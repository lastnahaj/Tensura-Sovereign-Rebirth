---
title: Danger Sense
description: Receive a mental warning when entities with hostile intent enter your proximity.
tags:
- Extra_Skills
- Abilities/Skills/Danger Sense
---
...
**Also known as:** Abilities/Skills/Danger Sense

<section class="reference-overview reference-theme-abilities">
<figure class="reference-overview-media reference-overview-media--source">
<img src="../../../../assets/upstream/tensura/skills/danger-sense-96b66f48e6.png" alt="Danger Sense source reference" loading="eager" decoding="async">
<figcaption><a href="https://tensura.wiki.gg/wiki/File:Danger_sense.png">Danger sense.png · CC BY-SA 4.0</a></figcaption>
</figure>
...
From Start</li></ul><p class="skill-evidence-note">An obtainment method is separate from a skill’s MP cost. Check all conditions; a listed route is not a guaranteed starting roll.</p></section>
<!-- skill-catalogue:end -->

<div class="tensura-reference-article">
<div class="mw-content-ltr mw-parser-output" dir="ltr" lang="en"><p>Receive a mental warning when entities with hostile intent enter your proximity.
</p>
<div class="druid-infobox druid-container druid-container-skill" id="druid-container-1"><div><div class="druid-title">Danger Sense</div></div><div class="druid-section-container"><div class="druid-main-image"><a class="image" href="https://tensura.wiki.gg/wiki/File:Danger_sense.png"><img alt="Danger sense.png" data-file-height="512" data-file-width="512" decoding="async" height="256" loading="lazy" src="../../../../assets/upstream/tensura/skills/danger-sense-96b66f48e6.png" width="256"/></a></div></div><div class="druid-section-container"><div data-druid-section="Information"><div class="druid-section druid-section-Information">Information</div></div><div class="druid-row druid-row-Type" data-druid-section-row="Information"><div class="druid-label druid-label-Type">Type</div><div class="druid-data druid-data-Type druid-data-nonempty">Extra Skill</div></div><div class="druid-row druid-row-ObtainCost" data-druid-section-row="Information"><div class="druid-label druid-label-ObtainCost">Obtain Cost</div><div class="druid-data druid-data-ObtainCost druid-data-nonempty">
...
<a class="mw-redirect" href="../sense-soundwave/" title="Abilities/Skills/Sense Soundwave">Sense Soundwave</a>, <a class="mw-redirect" href="../../../magic/magic-sense/" title="Abilities/Skills/Magic Sense">Magic Sense</a></div></div></div><div class="druid-section-container"><div data-druid-section="Obtaining"><div class="druid-section druid-section-Obtaining">Obtaining</div></div><div class="druid-row druid-row-EP" data-druid-section-row="Obtaining"><div class="druid-label druid-label-EP">EP</div><div class="druid-data druid-data-EP druid-data-nonempty">
From Start</div></div></div></div>
<h2><span class="mw-headline" id="Usage">Usage</span></h2>
<h3><span class="mw-headline" id="Passive">Passive</span></h3>
<ul><li>[Passive - Toggle] - Costs 0MP. If a mob starts to target the user, play a bell noise to the user.</li></ul>
...
Base Tensura reference adapted from [Danger Sense](https://tensura.wiki.gg/wiki/Danger_Sense) on the Tensura: Reincarnated Wiki (revision `11069`, modified `2026-03-22T21:56:02Z`). Adapted text is available under [CC BY-SA 4.0](https://creativecommons.org/licenses/by-sa/4.0/).

<details class="reference-media-credits">
<summary>Media credits (1 source files)</summary>
<ul>
<li><a href="https://tensura.wiki.gg/wiki/File:Danger_sense.png">Danger sense.png</a> — CC BY-SA 4.0; uploaded by Zykestheone; revision 3368</li>
</ul>
</details>
