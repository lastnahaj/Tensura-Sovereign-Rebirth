---
title: Future Attack Prediction
description: Future Attack Prediction - While this skill is in-slot, the user can see attacks before they are made. The user sees the attack almost before it happens, giving them a 75% Dodge Chance and 100% Dodge Negation. Future Attack Prediction cannot be bypassed by the likes of normal dodge negation.
tags:
...
Obtain Raphael and defeat Hinata</div></div></div></div>
<h2><span class="mw-headline" id="Usage">Usage</span></h2>
<h3><span class="mw-headline" id="Passive">Passive</span></h3>
<ul><li>[Passive, In-Slot] Future Attack Prediction - While this skill is in-slot, the user can see attacks before they are made. The user sees the attack almost before it happens, giving them a 75% Dodge Chance and 100% Dodge Negation. Future Attack Prediction cannot be bypassed by the likes of normal dodge negation.</li></ul>
<h3><span class="mw-headline" id="Active">Active</span></h3>
<ul><li>[Active, Press] Precognative Movement - When pressed. the next attack will be negated and the user will dash out of the way of the attack entirely. This has a three second cooldown.</li></ul>
</div>
</div>
