---
title: Flame Manipulation
description: Boosts the power of fire skills by a decent amount.
tags:
- Extra_Skills
- Abilities/Skills/Flame Manipulation
---
...
**Also known as:** Abilities/Skills/Flame Manipulation

<section class="reference-overview reference-theme-abilities">
<figure class="reference-overview-media reference-overview-media--source">
<img src="../../../../assets/upstream/tensura/skills/flame-manipulation-39ef1ccc7f.png" alt="Flame Manipulation source reference" loading="eager" decoding="async">
<figcaption><a href="https://tensura.wiki.gg/wiki/File:Flame_manipulation.png">Flame manipulation.png · CC BY-SA 4.0</a></figcaption>
</figure>
...
<a href="../flame-domination/" title="Flame Domination">Flame Domination</a>, <a href="../heat-wave/" title="Heat Wave">Heat Wave</a>, <a href="../molecular-manipulation/" title="Molecular Manipulation">Molecular Manipulation</a></div></div></div><div class="druid-section-container"><div data-druid-section="Obtaining"><div class="druid-section druid-section-Obtaining">Obtaining</div></div><div class="druid-row druid-row-Copying/Stealing" data-druid-section-row="Obtaining"><div class="druid-label druid-label-Copying/Stealing">Copying/Stealing</div><div class="druid-data druid-data-Copying/Stealing druid-data-nonempty">
Player, <a href="../../../mobs/mobs-salamander/" title="Mobs/Salamander">Salamander</a>, <a href="../../../bosses/mobs-ifrit/" title="Mobs/Ifrit">Ifrit</a></div></div><div class="druid-row druid-row-ObtainingaSpirit" data-druid-section-row="Obtaining"><div class="druid-label druid-label-ObtainingaSpirit">Obtaining a Spirit</div><div class="druid-data druid-data-ObtainingaSpirit druid-data-nonempty">
Flame Spirit</div></div></div></div>

<h2><span class="mw-headline" id="Extra_obtainment_method">Extra obtainment method</span></h2>
<p>Mastering 3 fire skills, the following skills can be mastered to obtain the skill:
</p>
<ul><li><a href="../black-flame/" title="Black Flame">Black Flame</a> <i>(If you already obtained it)</i></li>
<li><a href="../../intrinsic/flame-breath/" title="Flame Breath">Flame Breath</a></li>
<li><a href="../../intrinsic/flame-transform/" title="Flame Transform">Flame Transform</a></li>
<li><a href="../../intrinsic/flame-transform/" title="Flame Transform">Magic Flame Transform</a></li></ul>
<h2><span class="mw-headline" id="Usage">Usage</span></h2>
<h3><span class="mw-headline" id="Passive">Passive</span></h3>
<ul><li>[Passive - Toggle] - Increases damage dealt by Fire/Flame related attacks by 1.5x. Doesn't Stack with <a href="../flame-domination/" title="Flame Domination">Flame Domination</a></li>
<li>[Passive - In Slot] - <b>Coating</b>: If the user is on fire: On tools it grants an autosmelt effect (ores into bars, wood into charcoal); on attacking enemies (melee and bows), set the target on fire for 5 seconds (10 if mastered)</li></ul>
<h3><span class="mw-headline" id="Active">Active</span></h3>
<ul><li>[Active - Hold] - Breathes fire. If user is burning, extinguishes the flames. 0 MP
<ul><li>Can be used infinitely if user has lava in spatial storage</li></ul></li></ul>
...
Base Tensura reference adapted from [Flame Manipulation](https://tensura.wiki.gg/wiki/Flame_Manipulation) on the Tensura: Reincarnated Wiki (revision `12734`, modified `2026-05-05T16:09:13Z`). Adapted text is available under [CC BY-SA 4.0](https://creativecommons.org/licenses/by-sa/4.0/).

<details class="reference-media-credits">
<summary>Media credits (1 source files)</summary>
<ul>
<li><a href="https://tensura.wiki.gg/wiki/File:Flame_manipulation.png">Flame manipulation.png</a> — CC BY-SA 4.0; uploaded by Zykestheone; revision 3363</li>
</ul>
</details>
