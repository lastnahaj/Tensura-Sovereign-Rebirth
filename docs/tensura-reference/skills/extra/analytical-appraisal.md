---
title: Analytical Appraisal
description: Assess the soul of your opponents to gain insight into their overall strength.
tags:
- Extra_Skills
- Abilities/Skills/Analytical Appraisal
---
...
**Also known as:** Abilities/Skills/Analytical Appraisal

<section class="reference-overview reference-theme-abilities">
<figure class="reference-overview-media reference-overview-media--source">
<img src="../../../../assets/upstream/tensura/skills/analytical-appraisal-bb01737e8d.png" alt="Analytical Appraisal source reference" loading="eager" decoding="async">
<figcaption><a href="https://tensura.wiki.gg/wiki/File:Analytical_appraisal.png">Analytical appraisal.png · CC BY-SA 4.0</a></figcaption>
</figure>
...
20,000</div></div><div class="druid-row druid-row-Other" data-druid-section-row="Obtaining"><div class="druid-label druid-label-Other">Other</div><div class="druid-data druid-data-Other druid-data-nonempty">
<a href="../../../magic/analyze/" title="Analyze"> Analyze</a> Mastered</div></div></div></div>
<h2><span class="mw-headline" id="Usage">Usage</span></h2>
<p><br/>
</p>
<h3><span class="mw-headline" id="Active">Active</span></h3>
<ul><li>[Active - Press] - When activated, creates a screen overlay that displays information about the currently looked at block or mob in 5 blocks radius (10 with Mastery). Analysis Level 1 - Displays Name, HP, MP, AP, Armor Points, etc. With Mastery - Analysis Level 2, displays the skills of the target <b>Only Players</b> (except for skills flagged as mastered). If a target has greater than 1.5X (2X with Mastery) the player's EP, then only its base stats are shown (Name, HP, SHP, Armor).
<ul><li>Shift + Activate to change between Block Only Analysis, Entity Only Analysis or Both.</li></ul></li></ul>
...
Base Tensura reference adapted from [Analytical Appraisal](https://tensura.wiki.gg/wiki/Analytical_Appraisal) on the Tensura: Reincarnated Wiki (revision `11581`, modified `2026-04-02T21:34:28Z`). Adapted text is available under [CC BY-SA 4.0](https://creativecommons.org/licenses/by-sa/4.0/).

<details class="reference-media-credits">
<summary>Media credits (1 source files)</summary>
<ul>
<li><a href="https://tensura.wiki.gg/wiki/File:Analytical_appraisal.png">Analytical appraisal.png</a> — CC BY-SA 4.0; uploaded by Zykestheone; revision 3373</li>
</ul>
</details>
