---
title: Majesty
description: By boosting your reputation with the villagers, gain a permanent Hero of the Village effect [Passive - Toggle] Grants the player a permanent Hero of the Village effect, giving them better prices at shops. View or edit this templateSkillsIntrinsic SkillsAbsorb & Dissolve • Beast Transformation • Blood...
tags:
- Extra_Skills
- Abilities/Skills/Majesty
---
...
**Also known as:** Abilities/Skills/Majesty

<section class="reference-overview reference-theme-abilities">
<figure class="reference-overview-media reference-overview-media--source">
<img src="../../../../assets/upstream/tensura/skills/majesty-8f7ecebd57.png" alt="Majesty source reference" loading="eager" decoding="async">
<figcaption><a href="https://tensura.wiki.gg/wiki/File:Majesty.png">Majesty.png · CC BY-SA 4.0</a></figcaption>
</figure>
...
Clear 10 Raids</div></div></div></div>
<p>By boosting your reputation with the villagers, gain a permanent Hero of the Village effect
</p>
<h2><span class="mw-headline" id="Usage">Usage</span></h2>
<p><br/>
</p>
<h3><span class="mw-headline" id="Passive">Passive</span></h3>
<ul><li>[Passive - Toggle] Grants the player a permanent Hero of the Village effect, giving them better prices at shops.</li></ul>
...
Base Tensura reference adapted from [Majesty](https://tensura.wiki.gg/wiki/Majesty) on the Tensura: Reincarnated Wiki (revision `10872`, modified `2025-11-23T17:48:07Z`). Adapted text is available under [CC BY-SA 4.0](https://creativecommons.org/licenses/by-sa/4.0/).

<details class="reference-media-credits">
<summary>Media credits (1 source files)</summary>
<ul>
<li><a href="https://tensura.wiki.gg/wiki/File:Majesty.png">Majesty.png</a> — CC BY-SA 4.0; uploaded by Zykestheone; revision 3342</li>
</ul>
</details>
