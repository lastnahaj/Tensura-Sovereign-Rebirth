---
title: Demon Lord Haki
description: Unleash your Demonic aura causing those around you to quake in fear.
tags:
- Extra_Skills
- Evolved_Skills
- Abilities/Skills/Demon Lord Haki
---
...
**Also known as:** Abilities/Skills/Demon Lord Haki

<section class="reference-overview reference-theme-abilities">
<figure class="reference-overview-media reference-overview-media--source">
<img src="../../../../assets/upstream/tensura/skills/demon-lord-haki-3738966967.png" alt="Demon Lord Haki source reference" loading="eager" decoding="async">
<figcaption><a href="https://tensura.wiki.gg/wiki/File:Demon_lord_haki.png">Demon lord haki.png · CC BY-SA 4.0</a></figcaption>
</figure>
...
Player</div></div><div class="druid-row druid-row-Other" data-druid-section-row="Obtaining"><div class="druid-label druid-label-Other">Other</div><div class="druid-data druid-data-Other druid-data-nonempty">
200,000 EP + Own <a class="mw-redirect" href="../haki/" title="Abilities/Skills/Haki">Haki</a> + <a class="mw-redirect" href="../../../core-mechanics/races-alignment/" title="Races/Majin">Majin</a></div></div></div></div>
<h2><span class="mw-headline" id="Usage">Usage</span></h2>
<h3><span class="mw-headline" id="Active">Active</span></h3>
<ul><li>[Active - Hold] - <b>Default</b> - With mastery, scroll while holding down the skill button to change the percentage of EP used for calculation. When activated 5% Speed (10% with mastery), all mobs within a 30x30 radius are affected. If their EP is &gt;= 75% of the user's used EP, it does nothing. Otherwise, give 2 Fear level for each 20% difference with the used EP. 50 MP per 20t.</li>
<li>[Active - Toggle] - <b>Coating</b> - Applies a buff to the users physical and battlewill attacks for 2 minutes, allowing their attacks to bypass Physical Attack Resistance (Nullification is also treated as Resistance) and damage Spiritual Lifeforms. 100 MP.</li></ul>
...
Base Tensura reference adapted from [Demon Lord Haki](https://tensura.wiki.gg/wiki/Demon_Lord_Haki) on the Tensura: Reincarnated Wiki (revision `8388`, modified `2025-03-12T16:28:17Z`). Adapted text is available under [CC BY-SA 4.0](https://creativecommons.org/licenses/by-sa/4.0/).

<details class="reference-media-credits">
<summary>Media credits (1 source files)</summary>
<ul>
<li><a href="https://tensura.wiki.gg/wiki/File:Demon_lord_haki.png">Demon lord haki.png</a> — CC BY-SA 4.0; uploaded by Zykestheone; revision 3367</li>
</ul>
</details>
