...
description: Open Ego Archive - Shows the current egos you have and their stats.
tags:
...
Obtain an <a href="https://tensuranightmares.wiki.gg/wiki/Egos" title="Egos">Ego</a> and eat something</li></ul><p class="skill-evidence-note">An obtainment method is separate from a skill’s MP cost. Check all conditions; a listed route is not a guaranteed starting roll.</p></section>
<!-- skill-catalogue:end -->

<div class="tensura-reference-article">
<div class="mw-content-ltr mw-parser-output" dir="ltr" lang="en">
<div class="druid-infobox druid-container noexcerpt druid-container-skill" id="druid-container-1"><div><div class="druid-title">Ego Management</div></div><div class="druid-section-container"></div><div class="druid-section-container"><div data-druid-section="Information"><div class="druid-section druid-section-Information">Information</div></div><div class="druid-row druid-row-Type" data-druid-section-row="Information"><div class="druid-label druid-label-Type">Type</div><div class="druid-data druid-data-Type druid-data-nonempty">Extra Skill</div></div><div class="druid-row druid-row-ObtainCost" data-druid-section-row="Information"><div class="druid-label druid-label-ObtainCost">Obtain Cost</div><div class="druid-data druid-data-ObtainCost druid-data-nonempty">
...
Obtain an <a href="https://tensuranightmares.wiki.gg/wiki/Egos" title="Egos">Ego</a> and eat something</div></div></div></div>
<h2><span class="mw-headline" id="Usage">Usage</span></h2>
<h3><span class="mw-headline" id="Active">Active</span></h3>
<ul><li>[Active, Press] Open Ego Archive - Shows the current egos you have and their stats.</li>
<li>[Active, Press] Open Evolution Menu - Opens a menu that allows you to evolve your egos when they reached a certain threshold.</li>
<li>[Active, Press] Disposal - Challenge a ego you have in your inner world to get rid of it.</li>
<li>[Active, Press] Awaken - Let the Ego have control of your body.</li></ul>
</div>
</div>
