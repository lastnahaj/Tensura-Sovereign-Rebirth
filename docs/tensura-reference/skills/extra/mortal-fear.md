---
title: Mortal Fear
description: Inspire a gripping fear of death in weaker enemies while empowering your allies in a short range. 50 MP per second for each subordinate. User's speed is reduced to 5% while active (10% with mastery). All mobs within a 10x10 radius of the user and user's subordinates are affected. If mob's EP is =<75...
tags:
- Extra_Skills
- Evolved_Skills
- Abilities/Skills/Mortal Fear
---
...
**Also known as:** Abilities/Skills/Mortal Fear

<section class="reference-overview reference-theme-abilities">
<figure class="reference-overview-media reference-overview-media--source">
<img src="../../../../assets/upstream/tensura/skills/mortal-fear-d9383c9cbd.png" alt="Mortal Fear source reference" loading="eager" decoding="async">
<figcaption><a href="https://tensura.wiki.gg/wiki/File:Mortal_fear.png">Mortal fear.png · CC BY-SA 4.0</a></figcaption>
</figure>
...
Mastered <a class="mw-redirect" href="../haki/" title="Abilities/Skills/Haki">Haki</a></li></ul><p class="skill-evidence-note">An obtainment method is separate from a skill’s MP cost. Check all conditions; a listed route is not a guaranteed starting roll.</p></section>
<!-- skill-catalogue:end -->

<div class="tensura-reference-article">
<div class="mw-content-ltr mw-parser-output" dir="ltr" lang="en"><div class="druid-infobox druid-container druid-container-skill" id="druid-container-1"><div><div class="druid-title">Mortal Fear</div></div><div class="druid-section-container"><div class="druid-main-image"><a class="image" href="https://tensura.wiki.gg/wiki/File:Mortal_fear.png"><img alt="Mortal fear.png" data-file-height="512" data-file-width="512" decoding="async" height="256" loading="lazy" src="../../../../assets/upstream/tensura/skills/mortal-fear-d9383c9cbd.png" width="256"/></a></div></div><div class="druid-section-container"><div data-druid-section="Information"><div class="druid-section druid-section-Information">Information</div></div><div class="druid-row druid-row-Type" data-druid-section-row="Information"><div class="druid-label druid-label-Type">Type</div><div class="druid-data druid-data-Type druid-data-nonempty">Extra Skill</div></div><div class="druid-row druid-row-ObtainCost" data-druid-section-row="Information"><div class="druid-label druid-label-ObtainCost">Obtain Cost</div><div class="druid-data druid-data-ObtainCost druid-data-nonempty">
...
<a class="mw-redirect" href="../haki/" title="Abilities/Skills/Haki">Haki</a></div></div></div><div class="druid-section-container"><div data-druid-section="Obtaining"><div class="druid-section druid-section-Obtaining">Obtaining</div></div><div class="druid-row druid-row-CombinationofSkills" data-druid-section-row="Obtaining"><div class="druid-label druid-label-CombinationofSkills">Combination of Skills</div><div class="druid-data druid-data-CombinationofSkills druid-data-nonempty">
Mastered <a class="mw-redirect" href="../haki/" title="Abilities/Skills/Haki">Haki</a></div></div></div></div>
<p>Inspire a gripping fear of death in weaker enemies while empowering your allies in a short range.
</p>
<h2><span class="mw-headline" id="Usage">Usage</span></h2>
<p><br/>
</p>
<ul><li>50 MP per second for each subordinate. User's speed is reduced to 5% while active (10% with mastery). All mobs within a 10x10 radius of the user and user's subordinates are affected. If mob's EP is =&lt;75% of the user's EP, it does nothing. Otherwise, give 1 Fear level for each 20% difference in EP. With mastery, scroll while holding down the skill button to change the percentage of EP used for calculation. Additionally grants a Strength 4 effect (Strength 8 with mastery) to user's subordinates for 1 minute.</li></ul>
...
Base Tensura reference adapted from [Mortal Fear](https://tensura.wiki.gg/wiki/Mortal_Fear) on the Tensura: Reincarnated Wiki (revision `11934`, modified `2026-04-19T02:47:40Z`). Adapted text is available under [CC BY-SA 4.0](https://creativecommons.org/licenses/by-sa/4.0/).

<details class="reference-media-credits">
<summary>Media credits (1 source files)</summary>
<ul>
<li><a href="https://tensura.wiki.gg/wiki/File:Mortal_fear.png">Mortal fear.png</a> — CC BY-SA 4.0; uploaded by Zykestheone; revision 3339</li>
</ul>
</details>
