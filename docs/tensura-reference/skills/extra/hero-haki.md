---
title: Hero Haki
description: Use your Hero Aura to inspire your allies and terrify your enemies.
tags:
- Extra_Skills
- Evolved_Skills
- Abilities/Skills/Hero Haki
---
...
**Also known as:** Abilities/Skills/Hero Haki

<section class="reference-overview reference-theme-abilities">
<figure class="reference-overview-media reference-overview-media--source">
<img src="../../../../assets/upstream/tensura/skills/hero-haki-48aa72466a.png" alt="Hero Haki source reference" loading="eager" decoding="async">
<figcaption><a href="https://tensura.wiki.gg/wiki/File:Hero_haki.png">Hero haki.png · CC BY-SA 4.0</a></figcaption>
</figure>
...
<a class="mw-redirect" href="../haki/" title="Abilities/Skills/Haki">Haki</a></div></div><div class="druid-row druid-row-Next" data-druid-section-row="Evolution"><div class="druid-label druid-label-Next">Next</div><div class="druid-data druid-data-Next druid-data-nonempty">
<a class="mw-redirect" href="../sacred-haki/" title="Abilities/Skills/Sacred Haki">Sacred haki</a></div></div></div><div class="druid-section-container"><div data-druid-section="Obtaining"><div class="druid-section druid-section-Obtaining">Obtaining</div></div><div class="druid-row druid-row-CombinationofSkills" data-druid-section-row="Obtaining"><div class="druid-label druid-label-CombinationofSkills">Combination of Skills</div><div class="druid-data druid-data-CombinationofSkills druid-data-nonempty">
<a class="mw-redirect" href="../haki/" title="Abilities/Skills/Haki">Haki</a> + 200,000 EP + Not <a class="mw-redirect" href="../../../core-mechanics/races-alignment/" title="Races/Majin">Majin</a></div></div></div></div>
<h2><span class="mw-headline" id="Usage">Usage</span></h2>
<h3><span class="mw-headline" id="Active">Active</span></h3>
<ul><li>[Active - Hold] - 25 MP per 20 ticks. When activated, all mobs within a 30x30 radius are affected. With mastery, scroll while holding down the skill button to change the percentage of EP used for calculation. If their EP is =&lt;75% of the user's used EP, it does nothing. Otherwise, give 1 Fear level for each 20% difference with the used EP</li></ul>
...
Base Tensura reference adapted from [Hero Haki](https://tensura.wiki.gg/wiki/Hero_Haki) on the Tensura: Reincarnated Wiki (revision `8513`, modified `2025-03-12T16:50:45Z`). Adapted text is available under [CC BY-SA 4.0](https://creativecommons.org/licenses/by-sa/4.0/).

<details class="reference-media-credits">
<summary>Media credits (1 source files)</summary>
<ul>
<li><a href="https://tensura.wiki.gg/wiki/File:Hero_haki.png">Hero haki.png</a> — CC BY-SA 4.0; uploaded by Zykestheone; revision 3356</li>
</ul>
</details>
