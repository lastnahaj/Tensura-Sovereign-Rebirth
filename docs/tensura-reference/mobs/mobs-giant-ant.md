...
<div class="mw-content-ltr mw-parser-output" dir="ltr" lang="en"><div class="druid-infobox druid-container druid-container-mob" id="druid-container-1"><div><div class="druid-title">Giant Ant</div></div><div class="druid-section-container"><div class="druid-main-image"><a class="image" href="https://tensura.wiki.gg/wiki/File:Giant_ant.gif"><img alt="Giant ant.gif" data-file-height="512" data-file-width="512" decoding="async" height="512" loading="lazy" src="../../../assets/upstream/tensura/mobs/giant-ant-4e3b228173.gif" width="512"/></a></div></div><div class="druid-section-container"><div data-druid-section="GeneralInfo"><div class="druid-section druid-section-GeneralInfo">General Info</div></div><div class="druid-row druid-row-biome" data-druid-section-row="GeneralInfo"><div class="druid-label druid-label-biome">Biome</div><div class="druid-data druid-data-biome druid-data-nonempty">
<a class="extiw" href="https://minecraft.wiki/w/Forest" title="mcw:Forest">Forest</a>,<a class="extiw" href="https://minecraft.wiki/w/Savanna" title="mcw:Savanna">Savanna</a></div></div></div><div class="druid-section-container"><div data-druid-section="Stats"><div class="druid-section druid-section-Stats">Stats</div></div><div class="druid-row druid-row-health" data-druid-section-row="Stats"><div class="druid-label druid-label-health">Health</div><div class="druid-data druid-data-health druid-data-nonempty">
...
<p>This mob will destroy trees in pursuit of its enemy. If the player remains out of reach, it will spit poison, creating a lingering cloud of deadly poison where it hits.
</p>
<h2><span class="mw-headline" id="Drops">Drops</span></h2>
<ul><li>2 - 3 <span class="nowrap"><span class="sprite-file"><a href="../../items/giant-ant-carapace/" title="Giant Ant Carapace"></a></span> <a href="../../items/giant-ant-carapace/" title="Giant Ant Carapace"><span class="sprite-text">Giant Ant Carapace</span></a></span></li>
<li>2 - 6 <span class="nowrap"><span class="sprite-file"><a href="../../items/giant-ant-leg/" title="Giant Ant Leg"></a></span> <a href="../../items/giant-ant-leg/" title="Giant Ant Leg"><span class="sprite-text">Giant Ant Leg</span></a></span></li>
...
<p>A named ant can be ridden using a <span class="nowrap"><span class="sprite-file"><a href="https://tensura.wiki.gg/wiki/Items/Misc/Monster_Saddle" title="Items/Misc/Monster Saddle"></a></span> <a class="new" href="https://tensura.wiki.gg/wiki/Items/Misc/Monster_Saddle?action=edit&amp;redlink=1" rel="nofollow" title="Items/Misc/Monster Saddle (page does not exist)"><span class="sprite-text"> Monster Saddle</span></a></span>, which is placed on it's thorax.
</p>
