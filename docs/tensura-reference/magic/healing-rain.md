---
title: Healing Rain
description: Heal everyone in the battlefield by making healing droplets rain Heals all entities that is not hostile to the caster in a 15x15 radius for 10HP each second, lasts 5s => 50 HP. Heals for 20HP OR 5% of the target's max HP (whichever is higher) each second View or edit this templateMagicView or edit this...
tags:
- Aspectual_Magic
---
...
<img src="../../../assets/upstream/tensura/magic/healing-rain-c3e1067ab9.png" alt="Healing Rain source reference" loading="eager" decoding="async">
<figcaption><a href="https://tensura.wiki.gg/wiki/File:Healing_rain.png">Healing rain.png · CC BY-SA 4.0</a></figcaption>
</figure>
...
5000</div></div><div class="druid-row druid-row-CastTime" data-druid-section-row="Information"><div class="druid-label druid-label-CastTime">Cast Time</div><div class="druid-data druid-data-CastTime druid-data-nonempty">
...
<p>Heal everyone in the battlefield by making healing droplets rain
</p>
<h2><span class="mw-headline" id="Effect">Effect</span></h2>
<p><br/>
</p>
<ul><li>Heals all entities that is not hostile to the caster in a 15x15 radius for 10HP each second, lasts 5s =&gt; 50 HP.</li></ul>
<p><br/>
</p>
<h2><span class="mw-headline" id="Mastery_Bonus">Mastery Bonus</span></h2>
<p><br/>
</p>
<ul><li>Heals for 20HP OR 5% of the target's max HP (whichever is higher) each second</li></ul>
<p><br/>
</p>
...
Base Tensura reference adapted from [Healing Rain](https://tensura.wiki.gg/wiki/Healing_Rain) on the Tensura: Reincarnated Wiki (revision `11094`, modified `2026-03-23T21:13:08Z`). Adapted text is available under [CC BY-SA 4.0](https://creativecommons.org/licenses/by-sa/4.0/).

<details class="reference-media-credits">
<summary>Media credits (1 source files)</summary>
<ul>
<li><a href="https://tensura.wiki.gg/wiki/File:Healing_rain.png">Healing rain.png</a> — CC BY-SA 4.0; uploaded by Hunterman4488; revision 12116</li>
</ul>
</details>
