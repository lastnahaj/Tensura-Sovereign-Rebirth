...
<ul><li>Shoots a purple energy projectile that on contact inflicts 30 seconds of burden III.</li></ul>
<h2><span class="mw-headline" id="Mastery_Bonus">Mastery Bonus</span></h2>
<p><br/>
</p>
<ul><li>Additionally deals 30 seconds of slowness II.</li></ul>
<p><br/>
</p>
...
Base Tensura reference adapted from [Burden](https://tensura.wiki.gg/wiki/Burden) on the Tensura: Reincarnated Wiki (revision `11081`, modified `2026-03-23T01:06:01Z`). Adapted text is available under [CC BY-SA 4.0](https://creativecommons.org/licenses/by-sa/4.0/).
