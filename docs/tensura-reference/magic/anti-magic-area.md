...
<img src="../../../assets/upstream/tensura/magic/anti-magic-area-5e3f2c5f61.png" alt="Anti-Magic Area source reference" loading="eager" decoding="async">
<figcaption><a href="https://tensura.wiki.gg/wiki/File:Anti_magic_area.png">Anti magic area.png · CC BY-SA 4.0</a></figcaption>
</figure>
...
<ul><li>Creates a 20x20 zone (radius 10) where Aspectual magic becomes impossible to use/activate, doing nothing when cast. Spirit Magic can still be used. Summoning magic cannot be used. Any magic already in effect stays in effect. Lasts for 1 minute. 5s cooldown.</li></ul>
<p><br/>
</p>
<h2><span class="mw-headline" id="Mastery_Bonus">Mastery Bonus</span></h2>
<p><br/>
</p>
<ul><li>Increases radius to 50x50 (radius 25). 3s cooldown.</li></ul>
<p><br/>
</p>
...
Base Tensura reference adapted from [Anti-Magic Area](https://tensura.wiki.gg/wiki/Anti-Magic_Area) on the Tensura: Reincarnated Wiki (revision `11120`, modified `2026-03-24T20:18:01Z`). Adapted text is available under [CC BY-SA 4.0](https://creativecommons.org/licenses/by-sa/4.0/).

<details class="reference-media-credits">
<summary>Media credits (1 source files)</summary>
<ul>
<li><a href="https://tensura.wiki.gg/wiki/File:Anti_magic_area.png">Anti magic area.png</a> — CC BY-SA 4.0; uploaded by Hunterman4488; revision 12096</li>
</ul>
</details>
