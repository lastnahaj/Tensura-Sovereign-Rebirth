---
title: Protection
description: Protect your body from damage using magic Grants the user "protection" effect for 2 minutes, giving them an extra 20 points of armor. Applies on an entity in 10 block radius instead when sneaking. Increases duration from 2 minutes to 10 minutes. View or edit this templateMagicView or edit this templateAspectual...
tags:
- Aspectual_Magic
---
...
<img src="../../../assets/upstream/tensura/magic/protection-6852075bc2.png" alt="Protection source reference" loading="eager" decoding="async">
<figcaption><a href="https://tensura.wiki.gg/wiki/File:Protection.png">Protection.png · CC BY-SA 4.0</a></figcaption>
</figure>
...
<p>Protect your body from damage using magic
</p>
<h2><span class="mw-headline" id="Effect">Effect</span></h2>
<p><br/>
</p>
<ul><li>Grants the user "protection" effect for 2 minutes, giving them an extra 20 points of armor. Applies on an entity in 10 block radius instead when sneaking.</li></ul>
<p><br/>
</p>
...
Base Tensura reference adapted from [Protection](https://tensura.wiki.gg/wiki/Protection) on the Tensura: Reincarnated Wiki (revision `11091`, modified `2026-03-23T20:31:27Z`). Adapted text is available under [CC BY-SA 4.0](https://creativecommons.org/licenses/by-sa/4.0/).

<details class="reference-media-credits">
<summary>Media credits (1 source files)</summary>
<ul>
<li><a href="https://tensura.wiki.gg/wiki/File:Protection.png">Protection.png</a> — CC BY-SA 4.0; uploaded by Hunterman4488; revision 12134</li>
</ul>
</details>
