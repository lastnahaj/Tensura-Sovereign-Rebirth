---
title: Agility
description: Greatly increase your agility and speed using magic Grants the user Swiftness III and Haste III for 2 minutes. Applies on an entity in 10 block radius instead when sneaking. Increases duration from 2 minutes to 10 minutes. View or edit this templateMagicView or edit this templateAspectual MagicFireFire...
tags:
- Aspectual_Magic
---
...
<div class="mw-content-ltr mw-parser-output" dir="ltr" lang="en"><div class="druid-infobox druid-container druid-container-magic" id="druid-container-1"><div><div class="druid-title">Agility</div></div><div class="druid-section-container"><div class="druid-main-image"><a class="image" href="https://tensura.wiki.gg/wiki/File:Agility.png"><img alt="Agility.png" data-file-height="512" data-file-width="512" decoding="async" height="256" src="../../../assets/upstream/tensura/magic/agility-2b49d49265.png" width="256"/></a></div></div><div class="druid-section-container"><div data-druid-section="Information"><div class="druid-section druid-section-Information">Information</div></div><div class="druid-row druid-row-Type" data-druid-section-row="Information"><div class="druid-label druid-label-Type">Type</div><div class="druid-data druid-data-Type druid-data-nonempty">
...
<p>Greatly increase your agility and speed using magic
</p>
<h2><span class="mw-headline" id="Effect">Effect</span></h2>
<p><br/>
</p>
<ul><li>Grants the user Swiftness III and Haste III for 2 minutes. Applies on an entity in 10 block radius instead when sneaking.</li></ul>
<p><br/>
</p>
...
Base Tensura reference adapted from [Agility](https://tensura.wiki.gg/wiki/Agility) on the Tensura: Reincarnated Wiki (revision `11090`, modified `2026-03-23T20:29:39Z`). Adapted text is available under [CC BY-SA 4.0](https://creativecommons.org/licenses/by-sa/4.0/).
