---
title: Flame Wall
description: Use illusions to cast a wall of blue flames Creates a wall of fire identical to the fire wall spell, but it deals only half a heart of contact damage of magic and little knockback. For people who can see through illusions, the fire instead appears to be blue. (Still uses the Flame Magic Circle) Mimics...
tags:
- Aspectual_Magic
- Illusion
---
...
<div class="mw-content-ltr mw-parser-output" dir="ltr" lang="en"><div class="druid-infobox druid-container druid-container-magic" id="druid-container-1"><div><div class="druid-title">Flame Wall</div></div><div class="druid-section-container"><div class="druid-main-image"></div></div><div class="druid-section-container"><div data-druid-section="Information"><div class="druid-section druid-section-Information">Information</div></div><div class="druid-row druid-row-Type" data-druid-section-row="Information"><div class="druid-label druid-label-Type">Type</div><div class="druid-data druid-data-Type druid-data-nonempty">
...
<p>Use illusions to cast a wall of blue flames
</p>
<h2><span class="mw-headline" id="Effect">Effect</span></h2>
<p><br/>
</p>
<ul><li>Creates a wall of fire identical to the fire wall spell, but it deals only half a heart of contact damage of magic and little knockback. For people who can see through illusions, the fire instead appears to be blue. (Still uses the Flame Magic Circle)</li></ul>
<p><br/>
</p>
<h2><span class="mw-headline" id="Mastery_Bonus">Mastery Bonus</span></h2>
<p><br/>
</p>
<ul><li>Mimics mastered fire wall spell instead (double duration but no knockback resist negation).</li></ul>
<p><br/>
</p>
...
Base Tensura reference adapted from [Flame Wall](https://tensura.wiki.gg/wiki/Flame_Wall) on the Tensura: Reincarnated Wiki (revision `11132`, modified `2026-03-24T20:54:50Z`). Adapted text is available under [CC BY-SA 4.0](https://creativecommons.org/licenses/by-sa/4.0/).
