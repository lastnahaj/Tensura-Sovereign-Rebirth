---
title: Recovery
description: Uses magic to greatly recover the casters vitality Restores 50% HP to the user or the mob/player they're looking at. Additionally restores 4 points of hunger and 10 saturation (similarly to eating 1 enchanted apple). 10s cooldown Doubles the oversaturation from the golden apple effect. (8 points of hunger...
tags:
- Aspectual_Magic
---
...
<img src="../../../assets/upstream/tensura/magic/recovery-9f57760f2a.png" alt="Recovery source reference" loading="eager" decoding="async">
<figcaption><a href="https://tensura.wiki.gg/wiki/File:Recovery.png">Recovery.png · CC BY-SA 4.0</a></figcaption>
</figure>
...
<p>Uses magic to greatly recover the casters vitality
</p>
<h2><span class="mw-headline" id="Effect">Effect</span></h2>
<p><br/>
</p>
<ul><li>Restores 50% HP to the user or the mob/player they're looking at. Additionally restores 4 points of hunger and 10 saturation (similarly to eating 1 enchanted apple). 10s cooldown</li></ul>
<p><br/>
</p>
<h2><span class="mw-headline" id="Mastery_Bonus">Mastery Bonus</span></h2>
<p><br/>
</p>
<ul><li>Doubles the oversaturation from the golden apple effect. (8 points of hunger and 20 saturation). 5s cooldown</li></ul>
<p><br/>
</p>
...
Base Tensura reference adapted from [Recovery](https://tensura.wiki.gg/wiki/Recovery) on the Tensura: Reincarnated Wiki (revision `11095`, modified `2026-03-23T21:16:22Z`). Adapted text is available under [CC BY-SA 4.0](https://creativecommons.org/licenses/by-sa/4.0/).

<details class="reference-media-credits">
<summary>Media credits (1 source files)</summary>
<ul>
<li><a href="https://tensura.wiki.gg/wiki/File:Recovery.png">Recovery.png</a> — CC BY-SA 4.0; uploaded by Hunterman4488; revision 12135</li>
</ul>
</details>
