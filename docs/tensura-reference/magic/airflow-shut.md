---
title: Airflow Shut
description: Silence the target making them unable to cast magic verbally Creates a 5x5 zone centered where the player's looking at that drains oxygen and inflicts 5 seconds of silence every 20 ticks. It will remain indefinitely while held down and will linger for 10 seconds after the button is released. Casting...
tags:
- Aspectual_Magic
---
...
<div class="mw-content-ltr mw-parser-output" dir="ltr" lang="en"><div class="druid-infobox druid-container druid-container-magic" id="druid-container-1"><div><div class="druid-title">Airflow Shut</div></div><div class="druid-section-container"><div class="druid-main-image"><a class="image" href="https://tensura.wiki.gg/wiki/File:Airflow_shut.png"><img alt="Airflow shut.png" data-file-height="512" data-file-width="512" decoding="async" height="256" src="../../../assets/upstream/tensura/magic/airflow-shut-db28670863.png" width="256"/></a></div></div><div class="druid-section-container"><div data-druid-section="Information"><div class="druid-section druid-section-Information">Information</div></div><div class="druid-row druid-row-Type" data-druid-section-row="Information"><div class="druid-label druid-label-Type">Type</div><div class="druid-data druid-data-Type druid-data-nonempty">
...
<p>Silence the target making them unable to cast magic verbally
</p>
<h2><span class="mw-headline" id="Effect">Effect</span></h2>
<p><br/>
</p>
<ul><li>Creates a 5x5 zone centered where the player's looking at that drains oxygen and inflicts 5 seconds of silence every 20 ticks. It will remain indefinitely while held down and will linger for 10 seconds after the button is released.</li></ul>
<h2><span class="mw-headline" id="Mastery_Bonus">Mastery Bonus</span></h2>
<p><br/>
</p>
<ul><li>Casting time reduced to 80 ticks.</li>
<li>Access to the Expanded Mode with 8x8 radius instead.</li></ul>
<p><br/>
</p>
...
Base Tensura reference adapted from [Airflow Shut](https://tensura.wiki.gg/wiki/Airflow_Shut) on the Tensura: Reincarnated Wiki (revision `11051`, modified `2026-03-22T16:04:23Z`). Adapted text is available under [CC BY-SA 4.0](https://creativecommons.org/licenses/by-sa/4.0/).
