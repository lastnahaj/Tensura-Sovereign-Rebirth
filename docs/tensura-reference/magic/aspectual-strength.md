---
title: Strength
description: Strengthen your muscles using magic Grants the user "Strength III" for 2 minutes. Applies on an entity in 10 block radius instead when sneaking. Increases duration from 2 minutes to 10 minutes. View or edit this templateMagicView or edit this templateAspectual MagicFireFire · Fire Lance · Fire Ball...
tags:
- Aspectual_Magic
---
...
<div class="mw-content-ltr mw-parser-output" dir="ltr" lang="en"><div class="druid-infobox druid-container druid-container-magic" id="druid-container-1"><div><div class="druid-title">Strength</div></div><div class="druid-section-container"><div class="druid-main-image"></div></div><div class="druid-section-container"><div data-druid-section="Information"><div class="druid-section druid-section-Information">Information</div></div><div class="druid-row druid-row-Type" data-druid-section-row="Information"><div class="druid-label druid-label-Type">Type</div><div class="druid-data druid-data-Type druid-data-nonempty">
...
<p>Strengthen your muscles using magic
</p>
<h2><span class="mw-headline" id="Effect">Effect</span></h2>
<p><br/>
</p>
<ul><li>Grants the user "Strength III" for 2 minutes. Applies on an entity in 10 block radius instead when sneaking.</li></ul>
...
Base Tensura reference adapted from [Aspectual Strength](https://tensura.wiki.gg/wiki/Aspectual_Strength) on the Tensura: Reincarnated Wiki (revision `11089`, modified `2026-03-23T20:28:17Z`). Adapted text is available under [CC BY-SA 4.0](https://creativecommons.org/licenses/by-sa/4.0/).
