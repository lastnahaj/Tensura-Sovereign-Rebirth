---
title: Magic Wall
description: Use pure magic to create a wall in front of you Creates a 4x4 wall made of barrier blocks that slows down entities that move through them by 50%. Reduce/negate magic damage projectiles that pass through that have damage lower than 30. Lasts for 10 seconds. Increases duration to 25 seconds, projectile...
tags:
- Aspectual_Magic
---
...
400 MP</div></div><div class="druid-row druid-row-CastTime" data-druid-section-row="Information"><div class="druid-label druid-label-CastTime">Cast Time</div><div class="druid-data druid-data-CastTime druid-data-nonempty">
...
<p>Use pure magic to create a wall in front of you
</p>
<h2><span class="mw-headline" id="Effect">Effect</span></h2>
<p><br/>
</p>
<ul><li>Creates a 4x4 wall made of barrier blocks that slows down entities that move through them by 50%. Reduce/negate magic damage projectiles that pass through that have damage lower than 30. Lasts for 10 seconds.</li></ul>
<p><br/>
</p>
<h2><span class="mw-headline" id="Mastery_Bonus">Mastery Bonus</span></h2>
<p><br/>
</p>
<ul><li>Increases duration to 25 seconds, projectile damage reduction to 50.</li>
<li>Cast time to 100 ticks.</li></ul>
<p><br/>
</p>
...
Base Tensura reference adapted from [Magic Wall](https://tensura.wiki.gg/wiki/Magic_Wall) on the Tensura: Reincarnated Wiki (revision `11114`, modified `2026-03-24T20:04:39Z`). Adapted text is available under [CC BY-SA 4.0](https://creativecommons.org/licenses/by-sa/4.0/).
