---
title: Wind Attack Resistance
description: 'Wind Attack Resistance is a Resistance Skill in Tensura: Reincarnated. When toggled, it resists Wind Attacks if they fall below 50% of your Max HP. If the attack is not below 50% of your Max HP the damage will be halved. Go to the Spirit Tree and let someone use Aerial Blade or Wind Blade on you If you...'
tags:
- Resistances
- Abilities/Skills/Wind Attack Resistance
---
...
<div class="mw-content-ltr mw-parser-output" dir="ltr" lang="en"><div class="druid-infobox druid-container druid-container-skill" id="druid-container-1"><div><div class="druid-title">Wind Attack Resistance</div></div><div class="druid-section-container"><div class="druid-main-image"></div></div><div class="druid-section-container"><div data-druid-section="Information"><div class="druid-section druid-section-Information">Information</div></div><div class="druid-row druid-row-Type" data-druid-section-row="Information"><div class="druid-label druid-label-Type">Type</div><div class="druid-data druid-data-Type druid-data-nonempty">
...
Breeze</div></div><div class="druid-row druid-row-Other" data-druid-section-row="Obtaining"><div class="druid-label druid-label-Other">Other</div><div class="druid-data druid-data-Other druid-data-nonempty">
Taking over 15 damage at once from any source of wind damage</div></div></div></div>
<p>Wind Attack Resistance is a Resistance Skill in Tensura: Reincarnated.
</p>
<h2><span class="mw-headline" id="Effect">Effect</span></h2>
<p>When toggled, it resists Wind Attacks if they fall below 50% of your Max HP.
If the attack is not below 50% of your Max HP the damage will be halved.
</p>
<h2><span class="mw-headline" id="Tips">Tips</span></h2>
<ul><li>Go to the Spirit Tree and let someone use Aerial Blade or Wind Blade on you</li>
<li>If you are playing alone then let a Feathered Serpent (Medium Wind Spirit) or Sylhp (Greater Wind Spirit) hit you</li></ul>
<p><br/>
<br/>
</p>
