---
title: Abnormal Condition Resistance
description: 'Abnormal Condition Resistance is a Resistance Skill in Tensura: Reincarnated. When toggled, it nullifies the effects of Hunger, Poison, Blindness, Confusion, Darkness, Mining Fatigue, Slowness, Weakness, Burden, Fragility and Curse. Go to the Spirit Tree and get someone else to hit you with Darkness...'
tags:
- Resistances
- Abilities/Skills/Abnormal Condition Resistance
---
...
<a class="mw-redirect" href="../abnormal-condition-nullification/" title="Abilities/Skills/Abnormal Condition Nullification">Abnormal Condition Nullification</a></div></div></div><div class="druid-section-container"><div data-druid-section="Obtaining"><div class="druid-section druid-section-Obtaining">Obtaining</div></div><div class="druid-row druid-row-Other" data-druid-section-row="Obtaining"><div class="druid-label druid-label-Other">Other</div><div class="druid-data druid-data-Other druid-data-nonempty">
Taking 15 points of damage from Fear, Insanity, Petrification</div></div></div></div>
<p><b>Abnormal Condition Resistance</b> is a <b>Resistance Skill</b> in Tensura: Reincarnated.
</p>
<h2><span class="mw-headline" id="Effect">Effect</span></h2>
<p>When toggled, it <b>nullifies</b> the effects of <b>Hunger, Poison, Blindness, Confusion, Darkness, Mining Fatigue, Slowness, Weakness, <a href="../../core-mechanics/effects-burden/" title="Effects/Burden">Burden</a>, <a href="../../core-mechanics/effects-fragility/" title="Effects/Fragility">Fragility</a> and Curse</b>.
</p>
<h2><span class="mw-headline" id="Tips">Tips</span></h2>
<ul><li>Go to the Spirit Tree and get someone else to hit you with Darkness Cannon or Haki if possible</li></ul>
<ul><li>Getting attacked by a <a href="../../mobs/mobs-basilisk/" title="Mobs/Basilisk">Basilisk</a>.</li></ul>
<p><br/>
<br/>
</p>
