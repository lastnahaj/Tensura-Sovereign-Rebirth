...
description: 'Corrosion Resistance is a Resistance Skill in Tensura: Reincarnated. When toggled, it nullifies the effects of Wither and prevents Corrosion damage if it falls below 50% of your Max HP. If the attack is not below 50% of your Max HP the damage will be halved. Go fight Orc Lord and let him hit you, if...'
tags:
- Resistances
- Abilities/Skills/Corrosion Resistance
---
...
<a class="mw-redirect" href="../corrosion-nullification/" title="Abilities/Skills/Corrosion Nullification">Corrosion Nullification</a></div></div></div><div class="druid-section-container"><div data-druid-section="Obtaining"><div class="druid-section druid-section-Obtaining">Obtaining</div></div><div class="druid-row druid-row-Other" data-druid-section-row="Obtaining"><div class="druid-label druid-label-Other">Other</div><div class="druid-data druid-data-Other druid-data-nonempty">
Taking over 5 damage at once from any source of Corrosion damage (Orc Lord, Slimes, etc.)</div></div></div></div>
<p>Corrosion Resistance is a Resistance Skill in Tensura: Reincarnated.
</p>
<h2><span class="mw-headline" id="Effect">Effect</span></h2>
<p>When toggled, it <b>nullifies</b> the effects of <b>Wither</b> and prevents <a href="../../core-mechanics/effects-corrosion/" title="Effects/Corrosion"><b>Corrosion</b></a> damage if it falls below 50% of your Max HP.
If the attack is not below 50% of your Max HP the damage will be halved.
</p>
<h2><span class="mw-headline" id="Tips">Tips</span></h2>
<ul><li>Go fight <a href="../../bosses/mobs-orc-lord/" title="Mobs/Orc Lord">Orc Lord</a> and let him hit you, if that doesn't work, try with an <a href="../../bosses/mobs-orc-disaster/" title="Mobs/Orc Disaster">Orc Disaster</a></li></ul>
<p><br/>
<br/>
</p>
