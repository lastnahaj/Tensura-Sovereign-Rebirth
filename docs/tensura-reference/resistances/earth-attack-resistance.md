---
title: Earth Attack Resistance
description: 'Earth Attack Resistance is a Resistance Skill in Tensura: Reincarnated. When toggled, prevents Earth damage if it falls below 50% of your Max HP. If the attack is not below 50% of your Max HP the damage will be halved. Go to the Spirit Tree and get another player to hit you with Earth Spikes If you are...'
tags:
- Resistances
- Abilities/Skills/Earth Attack Resistance
---
...
<a class="mw-redirect" href="../earth-attack-nullification/" title="Abilities/Skills/Earth Attack Nullification">Earth Attack Nullification</a></div></div></div><div class="druid-section-container"><div data-druid-section="Obtaining"><div class="druid-section druid-section-Obtaining">Obtaining</div></div><div class="druid-row druid-row-Other" data-druid-section-row="Obtaining"><div class="druid-label druid-label-Other">Other</div><div class="druid-data druid-data-Other druid-data-nonempty">
Taking over 15 damage at once from any source of Earth damage</div></div></div></div>
<p>Earth Attack Resistance is a Resistance Skill in Tensura: Reincarnated.
</p>
<h2><span class="mw-headline" id="Effect">Effect</span></h2>
<p>When toggled, prevents <b>Earth</b> damage if it falls below 50% of your Max HP.
If the attack is not below 50% of your Max HP the damage will be halved.
</p>
<h2><span class="mw-headline" id="Tips">Tips</span></h2>
<ul><li>Go to the Spirit Tree and get another player to hit you with Earth Spikes</li>
<li>If you are playing alone your best option would be to fight the War Gnome (Greater Earth Elemental) that Hinata summons or plunder it from a Beast Gnome (Medium Earth Elemental)</li></ul>
<p><br/>
<br/>
</p>
