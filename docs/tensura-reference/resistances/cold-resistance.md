...
description: 'Cold Resistance is a Resistance Skill in Tensura: Reincarnated. When toggled, it nullifies the effects of Chill and prevents Cold damage if it falls below 50% of your Max HP. If the attack is not below 50% of your Max HP the damage will be halved. If you are playing alone get hit by Ice Dragon''s Ice...'
tags:
- Pages_using_duplicate_arguments_in_template_calls
- Resistances
- Abilities/Skills/Cold Resistance
---
...
<div class="mw-content-ltr mw-parser-output" dir="ltr" lang="en"><div class="druid-infobox druid-container druid-container-skill" id="druid-container-1"><div><div class="druid-title">Cold Resistance</div></div><div class="druid-section-container"><div class="druid-main-image"></div></div><div class="druid-section-container"><div data-druid-section="Information"><div class="druid-section druid-section-Information">Information</div></div><div class="druid-row druid-row-Type" data-druid-section-row="Information"><div class="druid-label druid-label-Type">Type</div><div class="druid-data druid-data-Type druid-data-nonempty">
...
<a href="../thermal-fluctuation-resistance/" title="Thermal Fluctuation Resistance">Thermal Flunctuation Resistance</a>, <a href="../cold-nullification/" title="Cold Nullification">Cold Nullification</a></div></div></div><div class="druid-section-container"><div data-druid-section="Obtaining"><div class="druid-section druid-section-Obtaining">Obtaining</div></div><div class="druid-row druid-row-Copying/Stealing" data-druid-section-row="Obtaining"><div class="druid-label druid-label-Copying/Stealing">Copying/Stealing</div><div class="druid-data druid-data-Copying/Stealing druid-data-nonempty">
<a class="external text" href="https://minecraft.fandom.com/wiki/Snow%20Golem" rel="nofollow">Snow Golem</a>, Ice Dragon</div></div><div class="druid-row druid-row-Other" data-druid-section-row="Obtaining"><div class="druid-label druid-label-Other">Other</div><div class="druid-data druid-data-Other druid-data-nonempty">
Taking over 15 damage at once from any source of Cold damage</div></div></div></div>
<p>Cold Resistance is a Resistance Skill in Tensura: Reincarnated.
</p>
<h2><span class="mw-headline" id="Effect">Effect</span></h2>
<p>When toggled, it nullifies the effects of Chill and prevents Cold damage if it falls below 50% of your Max HP.
If the attack is not below 50% of your Max HP the damage will be halved.
</p>
<h2><span class="mw-headline" id="Tips">Tips</span></h2>
<ul><li>If you are playing alone get hit by Ice Dragon's Ice Breath (Ice and Fire Mod)</li></ul>
<p>Recommended that you should have a way to get Fragility to increase the damage taken.
</p><p>Ex: fragility potions or the Shrink Spell.
<br/>
<br/>
</p>
