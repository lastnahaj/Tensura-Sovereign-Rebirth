...
<span class="tsr-status">Base mechanic</span>

Reincarnation is the opening and replay foundation for TSR. The pack layers race restrictions, prestige, Soul Grade, and authored campaign guidance around the base mechanic without replacing its documented behavior.
...
<ul>
<li><a href="https://tensura.wiki.gg/wiki/File:Reincarnation_aspectual.png">Reincarnation aspectual.png</a> — CC BY-SA 4.0; uploaded by Hunterman4488; revision 12136</li>
</ul>
</details>
