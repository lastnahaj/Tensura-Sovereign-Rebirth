...
Base Tensura reference adapted from [Effects/Insanity](https://tensura.wiki.gg/wiki/Effects/Insanity) on the Tensura: Reincarnated Wiki (revision `10688`, modified `2025-10-03T08:10:29Z`). Adapted text is available under [CC BY-SA 4.0](https://creativecommons.org/licenses/by-sa/4.0/).

<details class="reference-media-credits">
<summary>Media credits (2 source files)</summary>
<ul>
<li><a href="https://tensura.wiki.gg/wiki/File:Insanity.png">Insanity.png</a> — CC BY-SA 4.0; uploaded by AlexMurray; revision 10687</li>
